...
-- 4. ALTER TABLE AND CREATE FOREIGN KEY

DROP TABLE IF EXISTS "public"."city";
-- This script only contains the table creation statements and does not fully represent the table in the database. It's still missing: indices, triggers. Do not use it as a backup.

-- DEFINE AND CREATE TABLE CITY
...
-- DEFINE AND CREATE TABLE CONTINENT
...
-- DEFINE AND CREATE TABLE COUNTRY
CREATE TABLE "public"."country" (
    "code" bpchar(3) NOT NULL,
    "name" text NOT NULL,
    "continent" int4 NOT NULL,
...
-- DEFINE AND CREATE TABLE COUNTRY_LANGUAGE
...
-- DEFINE AND CREATE TABLE LANGUAGE
...
INSERT INTO "public"."continent" ("code", "name") VALUES
(1, 'Africa'),
(2, 'Antarctica'),
(3, 'Asia'),
(4, 'Central America'),
...
('ABW', 'Aruba', 6, 'Caribbean', 193, NULL, 103000, 78.4, 828.00, 793.00, 'Aruba', 'Nonmetropolitan Territory of The Netherlands', 'Beatrix', 129, 'AW'),
('AFG', 'Afghanistan', 3, 'Southern Asia', 652860, 1919, 40000000, 62, 69000000.00, NULL, 'Afghanistan', 'Totalitarian', NULL, NULL, 'AF'),
('AGO', 'Angola', 1, 'Central Africa', 1.2467e+06, 1975, 12878000, 38.3, 6648.00, 7984.00, 'Angola', 'Republic', 'Jos  Eduardo dos Santos', 56, 'AO'),
('AIA', 'Anguilla', 6, 'Caribbean', 96, NULL, 8000, 76.1, 63.20, NULL, 'Anguilla', 'Dependent Territory of the UK', 'Elisabeth II', 62, 'AI'),
('ALB', 'Albania', 5, 'Southern Europe', 28748, 1912, 3401200, 71.6, 3205.00, 2500.00, 'Shqip ria', 'Republic', 'Rexhep Mejdani', 34, 'AL'),
('AND', 'Andorra', 5, 'Southern Europe', 468, 1278, 78000, 83.5, 1630.00, NULL, 'Andorra', 'Parliamentary Coprincipality', '', 55, 'AD'),
('ANT', 'Netherlands Antilles', 6, 'Caribbean', 800, NULL, 217000, 74.7, 1941.00, NULL, 'Nederlandse Antillen', 'Nonmetropolitan Territory of The Netherlands', 'Beatrix', 33, 'AN'),
('ARE', 'United Arab Emirates', 3, 'Middle East', 83600, 1971, 2441000, 74.1, 37966.00, 36846.00, 'Al-Imarat al- Arabiya al-Muttahida', 'Emirate Federation', 'Zayid bin Sultan al-Nahayan', 65, 'AE'),
('ARG', 'Argentina', 8, 'South America', 2.7804e+06, 1816, 37032000, 75.1, 340238.00, 323310.00, 'Argentina', 'Federal Republic', 'Fernando de la R a', 69, 'AR'),
('ARM', 'Armenia', 3, 'Middle East', 29800, 1991, 3520000, 66.4, 1813.00, 1627.00, 'Hajastan', 'Republic', 'Robert Kot arjan', 126, 'AM'),
('ASM', 'American Samoa', 7, 'Polynesia', 199, NULL, 68000, 75.1, 334.00, NULL, 'Amerika Samoa', 'US Territory', 'George W. Bush', 54, 'AS'),
('ATA', 'Antarctica', 2, 'Antarctica', 1.312e+07, NULL, 0, NULL, 0.00, NULL, ' ', 'Co-administrated', '', NULL, 'AQ'),
('ATF', 'French Southern territories', 2, 'Antarctica', 7780, NULL, 0, NULL, 0.00, NULL, 'Terres australes fran aises', 'Nonmetropolitan Territory of France', 'Jacques Chirac', NULL, 'TF'),
('ATG', 'Antigua and Barbuda', 6, 'Caribbean', 442, 1981, 68000, 70.5, 612.00, 584.00, 'Antigua and Barbuda', 'Constitutional Monarchy', 'Elisabeth II', 63, 'AG'),
('AUS', 'Australia', 7, 'Australia and New Zealand', 7.74122e+06, 1901, 18886000, 79.8, 351182.00, 392911.00, 'Australia', 'Constitutional Monarchy, Federation', 'Elisabeth II', 135, 'AU'),
('AUT', 'Austria', 5, 'Western Europe', 83859, 1918, 8091800, 77.7, 211860.00, 206025.00, ' sterreich', 'Federal Republic', 'Thomas Klestil', 1523, 'AT'),
('AZE', 'Azerbaijan', 3, 'Middle East', 86600, 1991, 7734000, 62.9, 4127.00, 4100.00, 'Az rbaycan', 'Federal Republic', 'Heyd r  liyev', 144, 'AZ'),
('BDI', 'Burundi', 1, 'Eastern Africa', 27834, 1962, 6695000, 46.2, 903.00, 982.00, 'Burundi/Uburundi', 'Republic', 'Pierre Buyoya', 552, 'BI'),
('BEL', 'Belgium', 5, 'Western Europe', 30518, 1830, 10239000, 77.8, 249704.00, 243948.00, 'Belgi /Belgique', 'Constitutional Monarchy, Federation', 'Albert II', 179, 'BE'),
('BEN', 'Benin', 1, 'Western Africa', 112622, 1960, 6097000, 50.2, 2357.00, 2141.00, 'B nin', 'Republic', 'Mathieu K r kou', 187, 'BJ'),
('BFA', 'Burkina Faso', 1, 'Western Africa', 274000, 1960, 11937000, 46.7, 2425.00, 2201.00, 'Burkina Faso', 'Republic', 'Blaise Compaor ', 549, 'BF'),
('BGD', 'Bangladesh', 3, 'Southern and Central Asia', 143998, 1971, 129155000, 60.2, 32852.00, 31966.00, 'Bangladesh', 'Republic', 'Shahabuddin Ahmad', 150, 'BD'),
('BGR', 'Bulgaria', 5, 'Eastern Europe', 110994, 1908, 8190900, 70.9, 12178.00, 10169.00, 'Balgarija', 'Republic', 'Petar Stojanov', 539, 'BG'),
('BHR', 'Bahrain', 3, 'Middle East', 694, 1971, 617000, 73, 6366.00, 6097.00, 'Al-Bahrayn', 'Monarchy (Emirate)', 'Hamad ibn Isa al-Khalifa', 149, 'BH'),
('BHS', 'Bahamas', 6, 'Caribbean', 13878, 1973, 307000, 71.1, 3527.00, 3347.00, 'The Bahamas', 'Constitutional Monarchy', 'Elisabeth II', 148, 'BS'),
('BIH', 'Bosnia and Herzegovina', 5, 'Southern Europe', 51197, 1992, 3972000, 71.5, 2841.00, NULL, 'Bosna i Hercegovina', 'Federal Republic', 'Ante Jelavic', 201, 'BA'),
('BLR', 'Belarus', 5, 'Eastern Europe', 207600, 1991, 10236000, 68, 13714.00, NULL, 'Belarus', 'Republic', 'Aljaksandr Luka enka', 3520, 'BY'),
('BLZ', 'Belize', 6, 'Central America', 22696, 1981, 241000, 70.9, 630.00, 616.00, 'Belize', 'Constitutional Monarchy', 'Elisabeth II', 185, 'BZ'),
('BMU', 'Bermuda', 6, 'North America', 53, NULL, 65000, 76.9, 2328.00, 2190.00, 'Bermuda', 'Dependent Territory of the UK', 'Elisabeth II', 191, 'BM'),
('BOL', 'Bolivia', 8, 'South America', 1.098581e+06, 1825, 8329000, 63.7, 8571.00, 7967.00, 'Bolivia', 'Republic', 'Hugo B nzer Su rez', 194, 'BO'),
('BRA', 'Brazil', 8, 'South America', 8.547403e+06, 1822, 170115000, 62.9, 776739.00, 804108.00, 'Brasil', 'Federal Republic', 'Fernando Henrique Cardoso', 211, 'BR'),
('BRB', 'Barbados', 6, 'Caribbean', 430, 1966, 270000, 73, 2223.00, 2186.00, 'Barbados', 'Constitutional Monarchy', 'Elisabeth II', 174, 'BB'),
('BRN', 'Brunei', 3, 'Southeast Asia', 5765, 1984, 328000, 73.6, 11705.00, 12460.00, 'Brunei Darussalam', 'Monarchy (Sultanate)', 'Haji Hassan al-Bolkiah', 538, 'BN'),
('BTN', 'Bhutan', 3, 'Southern and Central Asia', 47000, 1910, 2124000, 52.4, 372.00, 383.00, 'Druk-Yul', 'Monarchy', 'Jigme Singye Wangchuk', 192, 'BT'),
('BVT', 'Bouvet Island', 2, 'Antarctica', 59, NULL, 0, NULL, 0.00, NULL, 'Bouvet ya', 'Dependent Territory of Norway', 'Harald V', NULL, 'BV'),
('BWA', 'Botswana', 1, 'Southern Africa', 581730, 1966, 1622000, 39.3, 4834.00, 4935.00, 'Botswana', 'Republic', 'Festus G. Mogae', 204, 'BW'),
('CAF', 'Central African Republic', 1, 'Central Africa', 622984, 1960, 3615000, 44, 1054.00, 993.00, 'Centrafrique/B -Afr ka', 'Republic', 'Ange-F lix Patass ', 1889, 'CF'),
('CAN', 'Canada', 6, 'North America', 9.97061e+06, 1867, 31147000, 79.4, 598862.00, 625626.00, 'Canada', 'Constitutional Monarchy, Federation', 'Elisabeth II', 1822, 'CA'),
('CCK', 'Cocos (Keeling) Islands', 7, 'Australia and New Zealand', 14, NULL, 600, NULL, 0.00, NULL, 'Cocos (Keeling) Islands', 'Territory of Australia', 'Elisabeth II', 2317, 'CC'),
('CHE', 'Switzerland', 5, 'Western Europe', 41284, 1499, 7160400, 79.6, 264478.00, 256092.00, 'Schweiz/Suisse/Svizzera/Svizra', 'Federation', 'Adolf Ogi', 3248, 'CH'),
('CHL', 'Chile', 8, 'South America', 756626, 1810, 15211000, 75.7, 72949.00, 75780.00, 'Chile', 'Republic', 'Ricardo Lagos Escobar', 554, 'CL'),
('CHN', 'China', 3, 'Eastern Asia', 9.5729e+06, -1523, 1277558000, 71.4, 982268.00, 917719.00, 'Zhongquo', 'People''sRepublic', 'Jiang Zemin', 1891, 'CN'),
('CIV', 'C te d Ivoire', 1, 'Western Africa', 322463, 1960, 14786000, 45.2, 11345.00, 10285.00, 'C te d Ivoire', 'Republic', 'Laurent Gbagbo', 2814, 'CI'),
('CMR', 'Cameroon', 1, 'Central Africa', 475442, 1960, 15085000, 54.8, 9174.00, 8596.00, 'Cameroun/Cameroon', 'Republic', 'Paul Biya', 1804, 'CM'),
('COD', 'Congo, The Democratic Republic of the', 1, 'Central Africa', 2.344858e+06, 1960, 51654000, 48.8, 6964.00, 2474.00, 'R publique D mocratique du Congo', 'Republic', 'Joseph Kabila', 2298, 'CD'),
('COG', 'Congo', 1, 'Central Africa', 342000, 1960, 2943000, 47.4, 2108.00, 2287.00, 'Congo', 'Republic', 'Denis Sassou-Nguesso', 2296, 'CG'),
('COK', 'Cook Islands', 7, 'Polynesia', 236, NULL, 20000, 71.1, 100.00, NULL, 'The Cook Islands', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 583, 'CK'),
('COL', 'Colombia', 8, 'South America', 1.138914e+06, 1810, 42321000, 70.3, 102896.00, 105116.00, 'Colombia', 'Republic', 'Andr s Pastrana Arango', 2257, 'CO'),
('COM', 'Comoros', 1, 'Eastern Africa', 1862, 1975, 578000, 60, 4401.00, 4361.00, 'Komori/Comores', 'Republic', 'Azali Assoumani', 2295, 'KM'),
('CPV', 'Cape Verde', 1, 'Western Africa', 4033, 1975, 428000, 68.9, 435.00, 420.00, 'Cabo Verde', 'Republic', 'Ant nio Mascarenhas Monteiro', 1859, 'CV'),
('CRI', 'Costa Rica', 4, 'Central America', 51100, 1821, 4023000, 75.8, 10226.00, 9757.00, 'Costa Rica', 'Republic', 'Miguel  ngel Rodr guez Echeverr a', 584, 'CR'),
('CUB', 'Cuba', 6, 'Caribbean', 110861, 1902, 11201000, 76.2, 17843.00, 18862.00, 'Cuba', 'Socialistic Republic', 'Fidel Castro Ruz', 2413, 'CU'),
('CXR', 'Christmas Island', 7, 'Australia and New Zealand', 135, NULL, 2500, NULL, 0.00, NULL, 'Christmas Island', 'Territory of Australia', 'Elisabeth II', 1791, 'CX'),
('CYM', 'Cayman Islands', 6, 'Caribbean', 264, NULL, 38000, 78.9, 1263.00, 1186.00, 'Cayman Islands', 'Dependent Territory of the UK', 'Elisabeth II', 553, 'KY'),
('CYP', 'Cyprus', 3, 'Middle East', 9251, 1960, 754700, 76.7, 9333.00, 8246.00, 'K pros/Kibris', 'Republic', 'Glafkos Klerides', 2430, 'CY'),
('CZE', 'Czech Republic', 5, 'Eastern Europe', 78866, 1993, 10278100, 74.5, 55017.00, 52037.00, ' esko', 'Republic', 'V clav Havel', 3339, 'CZ'),
('DEU', 'Germany', 5, 'Western Europe', 357022, 1955, 82164700, 77.4, 2133367.00, 2102826.00, 'Deutschland', 'Federal Republic', 'Johannes Rau', 3068, 'DE'),
('DJI', 'Djibouti', 1, 'Eastern Africa', 23200, 1977, 638000, 50.8, 382.00, 373.00, 'Djibouti/Jibuti', 'Republic', 'Ismail Omar Guelleh', 585, 'DJ'),
('DMA', 'Dominica', 6, 'Caribbean', 751, 1978, 71000, 73.4, 256.00, 243.00, 'Dominica', 'Republic', 'Vernon Shaw', 586, 'DM'),
('DNK', 'Denmark', 5, 'Nordic Countries', 43094, 800, 5330000, 76.5, 174099.00, 169264.00, 'Danmark', 'Constitutional Monarchy', 'Margrethe II', 3315, 'DK'),
('DOM', 'Dominican Republic', 6, 'Caribbean', 48511, 1844, 8495000, 73.2, 15846.00, 15076.00, 'Rep blica Dominicana', 'Republic', 'Hip lito Mej a Dom nguez', 587, 'DO'),
('DZA', 'Algeria', 1, 'Northern Africa', 2.381741e+06, 1962, 31471000, 69.7, 49982.00, 46966.00, 'Al-Jaza ir/Alg rie', 'Republic', 'Abdelaziz Bouteflika', 35, 'DZ'),
('ECU', 'Ecuador', 8, 'South America', 283561, 1822, 12646000, 71.1, 19770.00, 19769.00, 'Ecuador', 'Republic', 'Gustavo Noboa Bejarano', 594, 'EC'),
('EGY', 'Egypt', 1, 'Northern Africa', 1.001449e+06, 1922, 68470000, 63.3, 82710.00, 75617.00, 'Misr', 'Republic', 'Hosni Mubarak', 608, 'EG'),
('ERI', 'Eritrea', 1, 'Eastern Africa', 117600, 1993, 3850000, 55.8, 650.00, 755.00, 'Ertra', 'Republic', 'Isayas Afewerki [Isaias Afwerki]', 652, 'ER'),
('ESH', 'Western Sahara', 1, 'Northern Africa', 266000, NULL, 293000, 49.8, 60.00, NULL, 'As-Sahrawiya', 'Occupied by Marocco', 'Mohammed Abdel Aziz', 2453, 'EH'),
('ESP', 'Spain', 5, 'Southern Europe', 505992, 1492, 39441700, 78.8, 553233.00, 532031.00, 'Espa a', 'Constitutional Monarchy', 'Juan Carlos I', 653, 'ES'),
('EST', 'Estonia', 5, 'Baltic Countries', 45227, 1991, 1439200, 69.5, 5328.00, 3371.00, 'Eesti', 'Republic', 'Lennart Meri', 3791, 'EE'),
('ETH', 'Ethiopia', 1, 'Eastern Africa', 1.1043e+06, -1000, 62565000, 45.2, 6353.00, 6180.00, 'YeItyop iya', 'Republic', 'Negasso Gidada', 756, 'ET'),
('FIN', 'Finland', 5, 'Nordic Countries', 338145, 1917, 5171300, 77.4, 121914.00, 119833.00, 'Suomi', 'Republic', 'Tarja Halonen', 3236, 'FI'),
('FJI', 'Fiji Islands', 7, 'Melanesia', 18274, 1970, 817000, 67.9, 1536.00, 2149.00, 'Fiji Islands', 'Republic', 'Josefa Iloilo', 764, 'FJ'),
('FLK', 'Falkland Islands', 8, 'South America', 12173, NULL, 2000, NULL, 0.00, NULL, 'Falkland Islands', 'Dependent Territory of the UK', 'Elisabeth II', 763, 'FK'),
('FRA', 'France', 5, 'Western Europe', 551500, 843, 59225700, 78.8, 1424285.00, 1392448.00, 'France', 'Republic', 'Jacques Chirac', 2974, 'FR'),
('FRO', 'Faroe Islands', 5, 'Nordic Countries', 1399, NULL, 43000, 78.4, 0.00, NULL, 'F royar', 'Part of Denmark', 'Margrethe II', 901, 'FO'),
('FSM', 'Micronesia, Federated States of', 7, 'Micronesia', 702, 1990, 119000, 68.6, 212.00, NULL, 'Micronesia', 'Federal Republic', 'Leo A. Falcam', 2689, 'FM'),
('GAB', 'Gabon', 1, 'Central Africa', 267668, 1960, 1226000, 50.1, 5493.00, 5279.00, 'Le Gabon', 'Republic', 'Omar Bongo', 902, 'GA'),
('GBR', 'United Kingdom', 5, 'British Islands', 242900, 1066, 59623400, 77.7, 1378330.00, 1296830.00, 'United Kingdom', 'Constitutional Monarchy', 'Elisabeth II', 456, 'GB'),
('GEO', 'Georgia', 3, 'Middle East', 69700, 1991, 4968000, 64.5, 6064.00, 5924.00, 'Sakartvelo', 'Republic', 'Eduard  evardnadze', 905, 'GE'),
('GHA', 'Ghana', 1, 'Western Africa', 238533, 1957, 20212000, 57.4, 7137.00, 6884.00, 'Ghana', 'Republic', 'John Kufuor', 910, 'GH'),
('GIB', 'Gibraltar', 5, 'Southern Europe', 6, NULL, 25000, 79, 258.00, NULL, 'Gibraltar', 'Dependent Territory of the UK', 'Elisabeth II', 915, 'GI'),
('GIN', 'Guinea', 1, 'Western Africa', 245857, 1958, 7430000, 45.6, 2352.00, 2383.00, 'Guin e', 'Republic', 'Lansana Cont ', 926, 'GN'),
('GLP', 'Guadeloupe', 6, 'Caribbean', 1705, NULL, 456000, 77, 3501.00, NULL, 'Guadeloupe', 'Overseas Department of France', 'Jacques Chirac', 919, 'GP'),
('GMB', 'Gambia', 1, 'Western Africa', 11295, 1965, 1305000, 53.2, 320.00, 325.00, 'The Gambia', 'Republic', 'Yahya Jammeh', 904, 'GM'),
('GNB', 'Guinea-Bissau', 1, 'Western Africa', 36125, 1974, 1213000, 49, 293.00, 272.00, 'Guin -Bissau', 'Republic', 'Kumba Ial ', 927, 'GW'),
('GNQ', 'Equatorial Guinea', 1, 'Central Africa', 28051, 1968, 453000, 53.6, 283.00, 542.00, 'Guinea Ecuatorial', 'Republic', 'Teodoro Obiang Nguema Mbasogo', 2972, 'GQ'),
('GRC', 'Greece', 5, 'Southern Europe', 131626, 1830, 10545700, 78.4, 120724.00, 119946.00, 'Ell da', 'Republic', 'Kostis Stefanopoulos', 2401, 'GR'),
('GRD', 'Grenada', 6, 'Caribbean', 344, 1974, 94000, 64.5, 318.00, NULL, 'Grenada', 'Constitutional Monarchy', 'Elisabeth II', 916, 'GD'),
('GRL', 'Greenland', 6, 'North America', 2.16609e+06, NULL, 56000, 68.1, 0.00, NULL, 'Kalaallit Nunaat/Gr nland', 'Part of Denmark', 'Margrethe II', 917, 'GL'),
('GTM', 'Guatemala', 6, 'Central America', 108889, 1821, 11385000, 66.2, 19008.00, 17797.00, 'Guatemala', 'Republic', 'Alfonso Portillo Cabrera', 922, 'GT'),
('GUF', 'French Guiana', 8, 'South America', 90000, NULL, 181000, 76.1, 681.00, NULL, 'Guyane fran aise', 'Overseas Department of France', 'Jacques Chirac', 3014, 'GF'),
('GUM', 'Guam', 7, 'Micronesia', 549, NULL, 168000, 77.8, 1197.00, 1136.00, 'Guam', 'US Territory', 'George W. Bush', 921, 'GU'),
('GUY', 'Guyana', 8, 'South America', 214969, 1966, 861000, 64, 722.00, 743.00, 'Guyana', 'Republic', 'Bharrat Jagdeo', 928, 'GY'),
('HKG', 'Hong Kong', 3, 'Eastern Asia', 1075, NULL, 6782000, 79.5, 166448.00, 173610.00, 'Xianggang/Hong Kong', 'Special Administrative Region of China', 'Jiang Zemin', 937, 'HK'),
('HMD', 'Heard Island and McDonald Islands', 2, 'Antarctica', 359, NULL, 0, NULL, 0.00, NULL, 'Heard and McDonald Islands', 'Territory of Australia', 'Elisabeth II', NULL, 'HM'),
('HND', 'Honduras', 4, 'Central America', 112088, 1838, 6485000, 69.9, 5333.00, 4697.00, 'Honduras', 'Republic', 'Carlos Roberto Flores Facuss ', 933, 'HN'),
('HRV', 'Croatia', 5, 'Southern Europe', 56538, 1991, 4473000, 73.7, 20208.00, 19300.00, 'Hrvatska', 'Republic', ' tipe Mesic', 2409, 'HR'),
('HTI', 'Haiti', 6, 'Caribbean', 27750, 1804, 8222000, 49.2, 3459.00, 3107.00, 'Ha ti/Dayti', 'Republic', 'Jean-Bertrand Aristide', 929, 'HT'),
('HUN', 'Hungary', 5, 'Eastern Europe', 93030, 1918, 10043200, 71.4, 48267.00, 45914.00, 'Magyarorsz g', 'Republic', 'Ferenc M dl', 3483, 'HU'),
('IDN', 'Indonesia', 3, 'Southeast Asia', 1.904569e+06, 1945, 212107000, 68, 84982.00, 215002.00, 'Indonesia', 'Republic', 'Abdurrahman Wahid', 939, 'ID'),
('IND', 'India', 3, 'Southern and Central Asia', 3.287263e+06, 1947, 1013662000, 62.5, 447114.00, 430572.00, 'Bharat/India', 'Federal Republic', 'Kocheril Raman Narayanan', 1109, 'IN'),
('IOT', 'British Indian Ocean Territory', 1, 'Eastern Africa', 78, NULL, 0, NULL, 0.00, NULL, 'British Indian Ocean Territory', 'Dependent Territory of the UK', 'Elisabeth II', NULL, 'IO'),
('IRL', 'Ireland', 5, 'British Islands', 70273, 1921, 3775100, 76.8, 75921.00, 73132.00, 'Ireland/ ire', 'Republic', 'Mary McAleese', 1447, 'IE'),
('IRN', 'Iran', 3, 'Southern and Central Asia', 1.648195e+06, 1906, 67702000, 69.7, 195746.00, 160151.00, 'Iran', 'Islamic Republic', 'Ali Mohammad Khatami-Ardakani', 1380, 'IR'),
('IRQ', 'Iraq', 3, 'Middle East', 438317, 1932, 23115000, 66.5, 11500.00, NULL, 'Al- Iraq', 'Republic', 'Saddam Hussein al-Takriti', 1365, 'IQ'),
('ISL', 'Iceland', 5, 'Nordic Countries', 103000, 1944, 279000, 79.4, 8255.00, 7474.00, ' sland', 'Republic', ' lafur Ragnar Gr msson', 1449, 'IS'),
('ISR', 'Israel', 3, 'Middle East', 21056, 1948, 6217000, 78.6, 97477.00, 98577.00, 'Yisra el/Isra il', 'Republic', 'Moshe Katzav', 1450, 'IL'),
('ITA', 'Italy', 5, 'Southern Europe', 301316, 1861, 57680000, 79, 1161755.00, 1145372.00, 'Italia', 'Republic', 'Carlo Azeglio Ciampi', 1464, 'IT'),
('JAM', 'Jamaica', 6, 'Caribbean', 10990, 1962, 2583000, 75.2, 6871.00, 6722.00, 'Jamaica', 'Constitutional Monarchy', 'Elisabeth II', 1530, 'JM'),
('JOR', 'Jordan', 3, 'Middle East', 88946, 1946, 5083000, 77.4, 7526.00, 7051.00, 'Al-Urdunn', 'Constitutional Monarchy', 'Abdullah II', 1786, 'JO'),
('JPN', 'Japan', 3, 'Eastern Asia', 377829, -660, 126714000, 80.7, 3787042.00, 4192638.00, 'Nihon/Nippon', 'Constitutional Monarchy', 'Akihito', 1532, 'JP'),
('KAZ', 'Kazakstan', 3, 'Southern and Central Asia', 2.7249e+06, 1991, 16223000, 63.2, 24375.00, 23383.00, 'Qazaqstan', 'Republic', 'Nursultan Nazarbajev', 1864, 'KZ'),
('KEN', 'Kenya', 1, 'Eastern Africa', 580367, 1963, 30080000, 48, 9217.00, 10241.00, 'Kenya', 'Republic', 'Daniel arap Moi', 1881, 'KE'),
('KGZ', 'Kyrgyzstan', 3, 'Southern and Central Asia', 199900, 1991, 4699000, 63.4, 1626.00, 1767.00, 'Kyrgyzstan', 'Republic', 'Askar Akajev', 2253, 'KG'),
('KHM', 'Cambodia', 3, 'Southeast Asia', 181035, 1953, 11168000, 56.5, 5121.00, 5670.00, 'K mpuch a', 'Constitutional Monarchy', 'Norodom Sihanouk', 1800, 'KH'),
('KIR', 'Kiribati', 7, 'Micronesia', 726, 1979, 83000, 59.8, 40.70, NULL, 'Kiribati', 'Republic', 'Teburoro Tito', 2256, 'KI'),
('KNA', 'Saint Kitts and Nevis', 6, 'Caribbean', 261, 1983, 38000, 70.7, 299.00, NULL, 'Saint Kitts and Nevis', 'Constitutional Monarchy', 'Elisabeth II', 3064, 'KN'),
('KOR', 'South Korea', 3, 'Eastern Asia', 99434, 1948, 46844000, 74.4, 320749.00, 442544.00, 'Taehan Min guk (Namhan)', 'Republic', 'Kim Dae-jung', 2331, 'KR'),
('KWT', 'Kuwait', 3, 'Middle East', 17818, 1961, 1972000, 76.1, 27037.00, 30373.00, 'Al-Kuwayt', 'Constitutional Monarchy (Emirate)', 'Jabir al-Ahmad al-Jabir al-Sabah', 2429, 'KW'),
('LAO', 'Laos', 3, 'Southeast Asia', 236800, 1953, 5433000, 53.1, 1292.00, 1746.00, 'Lao', 'Republic', 'Khamtay Siphandone', 2432, 'LA'),
('LBN', 'Lebanon', 3, 'Middle East', 10400, 1941, 3282000, 71.3, 17121.00, 15129.00, 'Lubnan', 'Republic', ' mile Lahoud', 2438, 'LB'),
('LBR', 'Liberia', 1, 'Western Africa', 111369, 1847, 3154000, 51, 2012.00, NULL, 'Liberia', 'Republic', 'Charles Taylor', 2440, 'LR'),
('LBY', 'Libyan Arab Jamahiriya', 1, 'Northern Africa', 1.75954e+06, 1951, 5605000, 75.5, 44806.00, 40562.00, 'Libiya', 'Socialistic State', 'Muammar al-Qadhafi', 2441, 'LY'),
('LCA', 'Saint Lucia', 6, 'Caribbean', 622, 1979, 154000, 72.3, 571.00, NULL, 'Saint Lucia', 'Constitutional Monarchy', 'Elisabeth II', 3065, 'LC'),
('LIE', 'Liechtenstein', 5, 'Western Europe', 160, 1806, 32300, 78.8, 1119.00, 1084.00, 'Liechtenstein', 'Constitutional Monarchy', 'Hans-Adam II', 2446, 'LI'),
('LKA', 'Sri Lanka', 3, 'Southern and Central Asia', 65610, 1948, 18827000, 71.8, 15706.00, 15091.00, 'Sri Lanka/Ilankai', 'Republic', 'Chandrika Kumaratunga', 3217, 'LK'),
('LSO', 'Lesotho', 1, 'Southern Africa', 30355, 1966, 2153000, 50.8, 1061.00, 1161.00, 'Lesotho', 'Constitutional Monarchy', 'Letsie III', 2437, 'LS'),
('LTU', 'Lithuania', 5, 'Baltic Countries', 65301, 1991, 3698500, 69.1, 10692.00, 9585.00, 'Lietuva', 'Republic', 'Valdas Adamkus', 2447, 'LT'),
('LUX', 'Luxembourg', 5, 'Western Europe', 2586, 1867, 435700, 77.1, 16321.00, 15519.00, 'Luxembourg/L tzebuerg', 'Constitutional Monarchy', 'Henri', 2452, 'LU'),
('LVA', 'Latvia', 5, 'Baltic Countries', 64589, 1991, 2424200, 68.4, 6398.00, 5639.00, 'Latvija', 'Republic', 'Vaira Vike-Freiberga', 2434, 'LV'),
('MAC', 'Macao', 3, 'Eastern Asia', 18, NULL, 473000, 81.6, 5749.00, 5940.00, 'Macau/Aomen', 'Special Administrative Region of China', 'Jiang Zemin', 2454, 'MO'),
('MAR', 'Morocco', 1, 'Northern Africa', 446550, 1956, 28351000, 69.1, 36124.00, 33514.00, 'Al-Maghrib', 'Constitutional Monarchy', 'Mohammed VI', 2486, 'MA'),
('MCO', 'Monaco', 5, 'Western Europe', 1.5, 1861, 34000, 78.8, 776.00, NULL, 'Monaco', 'Constitutional Monarchy', 'Rainier III', 2695, 'MC'),
('MDA', 'Moldova', 5, 'Eastern Europe', 33851, 1991, 4380000, 64.5, 1579.00, 1872.00, 'Moldova', 'Republic', 'Vladimir Voronin', 2690, 'MD'),
('MDG', 'Madagascar', 1, 'Eastern Africa', 587041, 1960, 15942000, 55, 3750.00, 3545.00, 'Madagasikara/Madagascar', 'Federal Republic', 'Didier Ratsiraka', 2455, 'MG'),
('MDV', 'Maldives', 3, 'Southern and Central Asia', 298, 1965, 286000, 62.2, 199.00, NULL, 'Dhivehi Raajje/Maldives', 'Republic', 'Maumoon Abdul Gayoom', 2463, 'MV'),
('MEX', 'Mexico', 6, 'Central America', 1.958201e+06, 1810, 98881000, 71.5, 414972.00, 401461.00, 'M xico', 'Federal Republic', 'Vicente Fox Quesada', 2515, 'MX'),
('MHL', 'Marshall Islands', 7, 'Micronesia', 181, 1990, 64000, 65.5, 97.00, NULL, 'Marshall Islands/Majol', 'Republic', 'Kessai Note', 2507, 'MH'),
('MKD', 'Macedonia', 5, 'Southern Europe', 25713, 1991, 2024000, 73.8, 1694.00, 1915.00, 'Makedonija', 'Republic', 'Boris Trajkovski', 2460, 'MK'),
('MLI', 'Mali', 1, 'Western Africa', 1.240192e+06, 1960, 11234000, 46.7, 2642.00, 2453.00, 'Mali', 'Republic', 'Alpha Oumar Konar ', 2482, 'ML'),
('MLT', 'Malta', 5, 'Southern Europe', 316, 1964, 380200, 77.9, 3512.00, 3338.00, 'Malta', 'Republic', 'Guido de Marco', 2484, 'MT'),
('MMR', 'Myanmar', 3, 'Southeast Asia', 676578, 1948, 45611000, 54.9, 180375.00, 171028.00, 'Myanma Pye', 'Republic', 'kenraali Than Shwe', 2710, 'MM'),
('MNG', 'Mongolia', 3, 'Eastern Asia', 1.5665e+06, 1921, 2662000, 67.3, 1043.00, 933.00, 'Mongol Uls', 'Republic', 'Natsagiin Bagabandi', 2696, 'MN'),
('MNP', 'Northern Mariana Islands', 7, 'Micronesia', 464, NULL, 78000, 75.5, 0.00, NULL, 'Northern Mariana Islands', 'Commonwealth of the US', 'George W. Bush', 2913, 'MP'),
('MOZ', 'Mozambique', 1, 'Eastern Africa', 801590, 1975, 19680000, 37.5, 2891.00, 2711.00, 'Mo ambique', 'Republic', 'Joaqu m A. Chissano', 2698, 'MZ'),
('MRT', 'Mauritania', 1, 'Western Africa', 1.02552e+06, 1960, 2670000, 50.8, 998.00, 1081.00, 'Muritaniya/Mauritanie', 'Republic', 'Maaouiya Ould Sid Ahmad Taya', 2509, 'MR'),
('MSR', 'Montserrat', 6, 'Caribbean', 102, NULL, 11000, 78, 109.00, NULL, 'Montserrat', 'Dependent Territory of the UK', 'Elisabeth II', 2697, 'MS'),
('MTQ', 'Martinique', 6, 'Caribbean', 1102, NULL, 395000, 78.3, 2731.00, 2559.00, 'Martinique', 'Overseas Department of France', 'Jacques Chirac', 2508, 'MQ'),
('MUS', 'Mauritius', 1, 'Eastern Africa', 2040, 1968, 1158000, 71, 4251.00, 4186.00, 'Mauritius', 'Republic', 'Cassam Uteem', 2511, 'MU'),
('MWI', 'Malawi', 1, 'Eastern Africa', 118484, 1964, 10925000, 37.6, 1687.00, 2527.00, 'Malawi', 'Republic', 'Bakili Muluzi', 2462, 'MW'),
('MYS', 'Malaysia', 3, 'Southeast Asia', 329758, 1957, 22244000, 70.8, 69213.00, 97884.00, 'Malaysia', 'Constitutional Monarchy, Federation', 'Salahuddin Abdul Aziz Shah Alhaj', 2464, 'MY'),
('MYT', 'Mayotte', 1, 'Eastern Africa', 373, NULL, 149000, 59.5, 0.00, NULL, 'Mayotte', 'Territorial Collectivity of France', 'Jacques Chirac', 2514, 'YT'),
('NAM', 'Namibia', 1, 'Southern Africa', 824292, 1990, 1726000, 42.5, 3101.00, 3384.00, 'Namibia', 'Republic', 'Sam Nujoma', 2726, 'NA'),
('NCL', 'New Caledonia', 7, 'Melanesia', 18575, NULL, 214000, 72.8, 3563.00, NULL, 'Nouvelle-Cal donie', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3493, 'NC'),
('NER', 'Niger', 1, 'Western Africa', 1.267e+06, 1960, 10730000, 41.3, 1706.00, 1580.00, 'Niger', 'Republic', 'Mamadou Tandja', 2738, 'NE'),
('NFK', 'Norfolk Island', 7, 'Australia and New Zealand', 36, NULL, 2000, NULL, 0.00, NULL, 'Norfolk Island', 'Territory of Australia', 'Elisabeth II', 2806, 'NF'),
('NGA', 'Nigeria', 1, 'Western Africa', 923768, 1960, 111506000, 51.6, 65707.00, 58623.00, 'Nigeria', 'Federal Republic', 'Olusegun Obasanjo', 2754, 'NG'),
('NIC', 'Nicaragua', 6, 'Central America', 130000, 1838, 5074000, 68.7, 1988.00, 2023.00, 'Nicaragua', 'Republic', 'Arnoldo Alem n Lacayo', 2734, 'NI'),
('NIU', 'Niue', 7, 'Polynesia', 260, NULL, 2000, NULL, 0.00, NULL, 'Niue', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 2805, 'NU'),
('NLD', 'Netherlands', 5, 'Western Europe', 41526, 1581, 15864000, 78.3, 371362.00, 360478.00, 'Nederland', 'Constitutional Monarchy', 'Beatrix', 5, 'NL'),
('NOR', 'Norway', 5, 'Nordic Countries', 323877, 1905, 4478500, 78.7, 145895.00, 153370.00, 'Norge', 'Constitutional Monarchy', 'Harald V', 2807, 'NO'),
('NPL', 'Nepal', 3, 'Southern and Central Asia', 147181, 1769, 23930000, 57.8, 4768.00, 4837.00, 'Nepal', 'Constitutional Monarchy', 'Gyanendra Bir Bikram', 2729, 'NP'),
('NRU', 'Nauru', 7, 'Micronesia', 21, 1968, 12000, 60.8, 197.00, NULL, 'Naoero/Nauru', 'Republic', 'Bernard Dowiyogo', 2728, 'NR'),
('NZL', 'New Zealand', 7, 'Australia and New Zealand', 270534, 1907, 3862000, 77.8, 54669.00, 64960.00, 'New Zealand/Aotearoa', 'Constitutional Monarchy', 'Elisabeth II', 3499, 'NZ'),
('OMN', 'Oman', 3, 'Middle East', 309500, 1951, 2542000, 71.8, 16904.00, 16153.00, ' Uman', 'Monarchy (Sultanate)', 'Qabus ibn Sa id', 2821, 'OM'),
('PAK', 'Pakistan', 3, 'Southern and Central Asia', 796095, 1947, 156483000, 61.1, 61289.00, 58549.00, 'Pakistan', 'Republic', 'Mohammad Rafiq Tarar', 2831, 'PK'),
('PAN', 'Panama', 6, 'Central America', 75517, 1903, 2856000, 75.5, 9131.00, 8700.00, 'Panam ', 'Republic', 'Mireya Elisa Moscoso Rodr guez', 2882, 'PA'),
('PCN', 'Pitcairn', 7, 'Polynesia', 49, NULL, 50, NULL, 0.00, NULL, 'Pitcairn', 'Dependent Territory of the UK', 'Elisabeth II', 2912, 'PN'),
('PER', 'Peru', 8, 'South America', 1.285216e+06, 1821, 25662000, 70, 64140.00, 65186.00, 'Per /Piruw', 'Republic', 'Valentin Paniagua Corazao', 2890, 'PE'),
('PHL', 'Philippines', 3, 'Southeast Asia', 300000, 1946, 75967000, 67.5, 65107.00, 82239.00, 'Pilipinas', 'Republic', 'Gloria Macapagal-Arroyo', 766, 'PH'),
('PLW', 'Palau', 7, 'Micronesia', 459, 1994, 19000, 68.6, 105.00, NULL, 'Belau/Palau', 'Republic', 'Kuniwo Nakamura', 2881, 'PW'),
('PNG', 'Papua New Guinea', 7, 'Melanesia', 462840, 1975, 4807000, 63.1, 4988.00, 6328.00, 'Papua New Guinea/Papua Niugini', 'Constitutional Monarchy', 'Elisabeth II', 2884, 'PG'),
('POL', 'Poland', 5, 'Eastern Europe', 323250, 1918, 38653600, 73.2, 151697.00, 135636.00, 'Polska', 'Republic', 'Aleksander Kwasniewski', 2928, 'PL'),
('PRI', 'Puerto Rico', 6, 'Caribbean', 8875, NULL, 3869000, 75.6, 34100.00, 32100.00, 'Puerto Rico', 'Commonwealth of the US', 'George W. Bush', 2919, 'PR'),
('PRK', 'North Korea', 3, 'Eastern Asia', 120538, 1948, 24039000, 70.7, 5332.00, NULL, 'Choson Minjujuui In min Konghwaguk (Bukhan)', 'Socialistic Republic', 'Kim Jong-il', 2318, 'KP'),
('PRT', 'Portugal', 5, 'Southern Europe', 91982, 1143, 9997600, 75.8, 105954.00, 102133.00, 'Portugal', 'Republic', 'Jorge Samp io', 2914, 'PT'),
('PRY', 'Paraguay', 8, 'South America', 406752, 1811, 5496000, 73.7, 8444.00, 9555.00, 'Paraguay', 'Republic', 'Luis  ngel Gonz lez Macchi', 2885, 'PY'),
('PSE', 'Palestine', 3, 'Middle East', 6257, NULL, 3101000, 71.4, 4173.00, NULL, 'Filastin', 'Autonomous Area', 'Yasser (Yasir) Arafat', 4074, 'PS'),
('PYF', 'French Polynesia', 7, 'Polynesia', 4000, NULL, 235000, 74.8, 818.00, 781.00, 'Polyn sie fran aise', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3016, 'PF'),
('QAT', 'Qatar', 3, 'Middle East', 11000, 1971, 599000, 72.4, 9472.00, 8920.00, 'Qatar', 'Monarchy', 'Hamad ibn Khalifa al-Thani', 2973, 'QA'),
('REU', 'R union', 1, 'Eastern Africa', 2510, NULL, 699000, 72.7, 8287.00, 7988.00, 'R union', 'Overseas Department of France', 'Jacques Chirac', 3017, 'RE'),
('ROM', 'Romania', 5, 'Eastern Europe', 238391, 1878, 22455500, 69.9, 38158.00, 34843.00, 'Rom nia', 'Republic', 'Ion Iliescu', 3018, 'RO'),
('RUS', 'Russian Federation', 5, 'Eastern Europe', 1.70754e+07, 1991, 146934000, 67.2, 276608.00, 442989.00, 'Rossija', 'Federal Republic', 'Vladimir Putin', 3580, 'RU'),
('RWA', 'Rwanda', 1, 'Eastern Africa', 26338, 1962, 7733000, 39.3, 2036.00, 1863.00, 'Rwanda/Urwanda', 'Republic', 'Paul Kagame', 3047, 'RW'),
('SAU', 'Saudi Arabia', 3, 'Middle East', 2.14969e+06, 1932, 21607000, 67.8, 137635.00, 146171.00, 'Al- Arabiya as-Sa udiya', 'Monarchy', 'Fahd ibn Abdul-Aziz al-Sa ud', 3173, 'SA'),
('SDN', 'Sudan', 1, 'Northern Africa', 2.505813e+06, 1956, 29490000, 56.6, 10162.00, NULL, 'As-Sudan', 'Islamic Republic', 'Omar Hassan Ahmad al-Bashir', 3225, 'SD'),
('SEN', 'Senegal', 1, 'Western Africa', 196722, 1960, 9481000, 62.2, 4787.00, 4542.00, 'S n gal/Sounougal', 'Republic', 'Abdoulaye Wade', 3198, 'SN'),
('SGP', 'Singapore', 3, 'Southeast Asia', 618, 1965, 3567000, 80.1, 86503.00, 96318.00, 'Singapore/Singapura/Xinjiapo/Singapur', 'Republic', 'Sellapan Rama Nathan', 3208, 'SG'),
('SGS', 'South Georgia and the South Sandwich Islands', 2, 'Antarctica', 3903, NULL, 0, NULL, 0.00, NULL, 'South Georgia and the South Sandwich Islands', 'Dependent Territory of the UK', 'Elisabeth II', NULL, 'GS'),
('SHN', 'Saint Helena', 1, 'Western Africa', 314, NULL, 6000, 76.8, 0.00, NULL, 'Saint Helena', 'Dependent Territory of the UK', 'Elisabeth II', 3063, 'SH'),
('SJM', 'Svalbard and Jan Mayen', 5, 'Nordic Countries', 62422, NULL, 3200, NULL, 0.00, NULL, 'Svalbard og Jan Mayen', 'Dependent Territory of Norway', 'Harald V', 938, 'SJ'),
('SLB', 'Solomon Islands', 7, 'Melanesia', 28896, 1978, 444000, 71.3, 182.00, 220.00, 'Solomon Islands', 'Constitutional Monarchy', 'Elisabeth II', 3161, 'SB'),
('SLE', 'Sierra Leone', 1, 'Western Africa', 71740, 1961, 4854000, 45.3, 746.00, 858.00, 'Sierra Leone', 'Republic', 'Ahmed Tejan Kabbah', 3207, 'SL'),
('SLV', 'El Salvador', 6, 'Central America', 21041, 1841, 6276000, 69.7, 11863.00, 11203.00, 'El Salvador', 'Republic', 'Francisco Guillermo Flores P rez', 645, 'SV'),
('SMR', 'San Marino', 5, 'Southern Europe', 61, 885, 27000, 81.1, 510.00, NULL, 'San Marino', 'Republic', '', 3171, 'SM'),
('SOM', 'Somalia', 1, 'Eastern Africa', 637657, 1960, 10097000, 46.2, 935.00, NULL, 'Soomaaliya', 'Republic', 'Abdiqassim Salad Hassan', 3214, 'SO'),
('SPM', 'Saint Pierre and Miquelon', 6, 'North America', 242, NULL, 7000, 77.6, 0.00, NULL, 'Saint-Pierre-et-Miquelon', 'Territorial Collectivity of France', 'Jacques Chirac', 3067, 'PM'),
('STP', 'Sao Tome and Principe', 1, 'Central Africa', 964, 1975, 147000, 65.3, 6.00, NULL, 'S o Tom  e Pr ncipe', 'Republic', 'Miguel Trovoada', 3172, 'ST'),
('SUR', 'Suriname', 8, 'South America', 163265, 1975, 417000, 71.4, 870.00, 706.00, 'Suriname', 'Republic', 'Ronald Venetiaan', 3243, 'SR'),
('SVK', 'Slovakia', 5, 'Eastern Europe', 49012, 1993, 5398700, 73.7, 20594.00, 19452.00, 'Slovensko', 'Republic', 'Rudolf Schuster', 3209, 'SK'),
('SVN', 'Slovenia', 5, 'Southern Europe', 20256, 1991, 1987800, 74.9, 19756.00, 18202.00, 'Slovenija', 'Republic', 'Milan Kucan', 3212, 'SI'),
('SWE', 'Sweden', 5, 'Nordic Countries', 449964, 836, 8861400, 79.6, 226492.00, 227757.00, 'Sverige', 'Constitutional Monarchy', 'Carl XVI Gustaf', 3048, 'SE'),
('SWZ', 'Swaziland', 1, 'Southern Africa', 17364, 1968, 1008000, 40.4, 1206.00, 1312.00, 'kaNgwane', 'Monarchy', 'Mswati III', 3244, 'SZ'),
('SYC', 'Seychelles', 1, 'Eastern Africa', 455, 1976, 77000, 70.4, 536.00, 539.00, 'Sesel/Seychelles', 'Republic', 'France-Albert Ren ', 3206, 'SC'),
('SYR', 'Syria', 3, 'Middle East', 185180, 1941, 16125000, 68.5, 65984.00, 64926.00, 'Suriya', 'Republic', 'Bashar al-Assad', 3250, 'SY'),
('TCA', 'Turks and Caicos Islands', 6, 'Caribbean', 430, NULL, 17000, 73.3, 96.00, NULL, 'The Turks and Caicos Islands', 'Dependent Territory of the UK', 'Elisabeth II', 3423, 'TC'),
('TCD', 'Chad', 1, 'Central Africa', 1.284e+06, 1960, 7651000, 50.5, 1208.00, 1102.00, 'Tchad/Tshad', 'Republic', 'Idriss D by', 3337, 'TD'),
('TGO', 'Togo', 1, 'Western Africa', 56785, 1960, 4629000, 54.7, 1449.00, 1400.00, 'Togo', 'Republic', 'Gnassingb  Eyad ma', 3332, 'TG'),
('THA', 'Thailand', 3, 'Southeast Asia', 513115, 1350, 61399000, 68.6, 116416.00, 153907.00, 'Prathet Thai', 'Constitutional Monarchy', 'Bhumibol Adulyadej', 3320, 'TH'),
('TJK', 'Tajikistan', 3, 'Southern and Central Asia', 143100, 1991, 6188000, 64.1, 1990.00, 1056.00, 'To ikiston', 'Republic', 'Emomali Rahmonov', 3261, 'TJ'),
('TKL', 'Tokelau', 7, 'Polynesia', 12, NULL, 2000, NULL, 0.00, NULL, 'Tokelau', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 3333, 'TK'),
('TKM', 'Turkmenistan', 3, 'Southern and Central Asia', 488100, 1991, 4459000, 60.9, 4397.00, 2000.00, 'T rkmenostan', 'Republic', 'Saparmurad Nijazov', 3419, 'TM'),
('TMP', 'East Timor', 3, 'Southeast Asia', 14874, NULL, 885000, 46, 0.00, NULL, 'Timor Timur', 'Administrated by the UN', 'Jos  Alexandre Gusm o', 1522, 'TP'),
('TON', 'Tonga', 7, 'Polynesia', 650, 1970, 99000, 67.9, 146.00, 170.00, 'Tonga', 'Monarchy', 'Taufa''ahau Tupou IV', 3334, 'TO'),
('TTO', 'Trinidad and Tobago', 6, 'Caribbean', 5130, 1962, 1295000, 68, 6232.00, 5867.00, 'Trinidad and Tobago', 'Republic', 'Arthur N. R. Robinson', 3336, 'TT'),
('TUN', 'Tunisia', 1, 'Northern Africa', 163610, 1956, 9586000, 73.7, 20026.00, 18898.00, 'Tunis/Tunisie', 'Republic', 'Zine al-Abidine Ben Ali', 3349, 'TN'),
('TUR', 'Turkey', 3, 'Middle East', 774815, 1923, 66591000, 71, 210721.00, 189122.00, 'T rkiye', 'Republic', 'Ahmet Necdet Sezer', 3358, 'TR'),
('TUV', 'Tuvalu', 7, 'Polynesia', 26, 1978, 12000, 66.3, 6.00, NULL, 'Tuvalu', 'Constitutional Monarchy', 'Elisabeth II', 3424, 'TV'),
('TWN', 'Taiwan', 3, 'Eastern Asia', 36188, 1945, 22256000, 76.4, 256254.00, 263451.00, 'T ai-wan', 'Republic', 'Chen Shui-bian', 3263, 'TW'),
('TZA', 'Tanzania', 1, 'Eastern Africa', 883749, 1961, 33517000, 52.3, 8005.00, 7388.00, 'Tanzania', 'Republic', 'Benjamin William Mkapa', 3306, 'TZ'),
('UGA', 'Uganda', 1, 'Eastern Africa', 241038, 1962, 21778000, 42.9, 6313.00, 6887.00, 'Uganda', 'Republic', 'Yoweri Museveni', 3425, 'UG'),
('UKR', 'Ukraine', 5, 'Eastern Europe', 603700, 1991, 50456000, 66, 42168.00, 49677.00, 'Ukrajina', 'Republic', 'Leonid Kut ma', 3426, 'UA'),
('UMI', 'United States Minor Outlying Islands', 7, 'Micronesia/Caribbean', 16, NULL, 0, NULL, 0.00, NULL, 'United States Minor Outlying Islands', 'Dependent Territory of the US', 'George W. Bush', NULL, 'UM'),
('URY', 'Uruguay', 8, 'South America', 175016, 1828, 3337000, 75.2, 20831.00, 19967.00, 'Uruguay', 'Republic', 'Jorge Batlle Ib  ez', 3492, 'UY'),
('USA', 'United States', 6, 'North America', 9.36352e+06, 1776, 278357000, 77.1, 8510700.00, 8110900.00, 'United States', 'Federal Republic', 'George W. Bush', 3813, 'US'),
('UZB', 'Uzbekistan', 3, 'Southern and Central Asia', 447400, 1991, 24318000, 63.7, 14194.00, 21300.00, 'Uzbekiston', 'Republic', 'Islam Karimov', 3503, 'UZ'),
('VAT', 'Holy See (Vatican City State)', 5, 'Southern Europe', 0.4, 1929, 1000, NULL, 9.00, NULL, 'Santa Sede/Citt  del Vaticano', 'Independent Church State', 'Johannes Paavali II', 3538, 'VA'),
('VCT', 'Saint Vincent and the Grenadines', 6, 'Caribbean', 388, 1979, 114000, 72.3, 285.00, NULL, 'Saint Vincent and the Grenadines', 'Constitutional Monarchy', 'Elisabeth II', 3066, 'VC'),
('VEN', 'Venezuela', 8, 'South America', 912050, 1811, 24170000, 73.1, 95023.00, 88434.00, 'Venezuela', 'Federal Republic', 'Hugo Ch vez Fr as', 3539, 'VE'),
('VGB', 'Virgin Islands, British', 6, 'Caribbean', 151, NULL, 21000, 75.4, 612.00, 573.00, 'British Virgin Islands', 'Dependent Territory of the UK', 'Elisabeth II', 537, 'VG'),
('VIR', 'Virgin Islands, U.S.', 6, 'Caribbean', 347, NULL, 93000, 78.1, 0.00, NULL, 'Virgin Islands of the United States', 'US Territory', 'George W. Bush', 4067, 'VI'),
('VNM', 'Vietnam', 3, 'Southeast Asia', 331689, 1945, 79832000, 69.3, 21929.00, 22834.00, 'Vi t Nam', 'Socialistic Republic', 'Tr n Duc Luong', 3770, 'VN'),
('VUT', 'Vanuatu', 7, 'Melanesia', 12189, 1980, 190000, 60.6, 261.00, 246.00, 'Vanuatu', 'Republic', 'John Bani', 3537, 'VU'),
('WLF', 'Wallis and Futuna', 7, 'Polynesia', 200, NULL, 15000, NULL, 0.00, NULL, 'Wallis-et-Futuna', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3536, 'WF'),
('WSM', 'Samoa', 7, 'Polynesia', 2831, 1962, 180000, 69.2, 141.00, 157.00, 'Samoa', 'Parlementary Monarchy', 'Malietoa Tanumafili II', 3169, 'WS'),
('YEM', 'Yemen', 3, 'Middle East', 527968, 1918, 18112000, 59.8, 6041.00, 5729.00, 'Al-Yaman', 'Republic', 'Ali Abdallah Salih', 1780, 'YE'),
('YUG', 'Yugoslavia', 5, 'Southern Europe', 102173, 1918, 10640000, 72.4, 17000.00, NULL, 'Jugoslavija', 'Federal Republic', 'Vojislav Ko tunica', 1792, 'YU'),
('ZAF', 'South Africa', 1, 'Southern Africa', 1.221037e+06, 1910, 40377000, 51.1, 116729.00, 129092.00, 'South Africa', 'Republic', 'Thabo Mbeki', 716, 'ZA'),
('ZMB', 'Zambia', 1, 'Eastern Africa', 752618, 1964, 9169000, 37.2, 3377.00, 3922.00, 'Zambia', 'Republic', 'Frederick Chiluba', 3162, 'ZM'),
('ZWE', 'Zimbabwe', 1, 'Eastern Africa', 390757, 1980, 11669000, 37.8, 5951.00, 8670.00, 'Zimbabwe', 'Republic', 'Robert G. Mugabe', 4068, 'ZW');

INSERT INTO "public"."countrylanguage" ("countrycode", "language", "isofficial", "percentage", "languagecode") VALUES
('ABW', 'Dutch', 't', 5.3, 105),
('ABW', 'English', 'f', 9.5, 110),
('ABW', 'Papiamento', 'f', 76.7, 329),
('ABW', 'Spanish', 'f', 7.4, 390),
('AFG', 'Balochi', 'f', 0.9, 31),
('AFG', 'Dari', 't', 32.1, 96),
('AFG', 'Turkmenian', 'f', 1.9, 429),
('AFG', 'Uzbek', 'f', 8.8, 437),
('AGO', 'Ambo', 'f', 2.4, 11),
('AGO', 'Chokwe', 'f', 4.2, 79),
('AGO', 'Kongo', 'f', 13.2, 203),
('AGO', 'Luchazi', 'f', 2.4, 226),
('AGO', 'Luimbe-nganguela', 'f', 5.4, 230),
('AGO', 'Luvale', 'f', 3.6, 233),
('AGO', 'Mbundu', 'f', 21.6, 273),
('AGO', 'Nyaneka-nkhumbi', 'f', 5.4, 314),
('AGO', 'Ovimbundu', 'f', 37.2, 324),
('AIA', 'English', 't', 0, 110),
('ALB', 'Albaniana', 't', 97.9, 10),
('ALB', 'Greek', 'f', 1.8, 143),
('ALB', 'Macedonian', 'f', 0.1, 235),
('AND', 'Catalan', 't', 32.3, 66),
('AND', 'French', 'f', 6.2, 119),
('AND', 'Portuguese', 'f', 10.8, 339),
('AND', 'Spanish', 'f', 44.6, 390),
('ANT', 'Dutch', 't', 0, 105),
('ANT', 'English', 'f', 7.8, 110),
('ANT', 'Papiamento', 't', 86.2, 329),
('ARE', 'Arabic', 't', 42, 15),
('ARE', 'Hindi', 'f', 0, 164),
('ARG', 'Indian Languages', 'f', 0.3, 174),
('ARG', 'Italian', 'f', 1.7, 176),
('ARG', 'Spanish', 't', 96.8, 390),
('ARM', 'Armenian', 't', 93.4, 20),
('ARM', 'Azerbaijani', 'f', 2.6, 25),
('ASM', 'English', 't', 3.1, 110),
('ASM', 'Samoan', 't', 90.6, 356),
('ASM', 'Tongan', 'f', 3.1, 419),
('ATG', 'Creole English', 'f', 95.7, 88),
('ATG', 'English', 't', 0, 110),
('AUS', 'Arabic', 'f', 1, 15),
('AUS', 'Canton Chinese', 'f', 1.1, 62),
('AUS', 'English', 't', 81.2, 110),
('AUS', 'German', 'f', 0.6, 135),
('AUS', 'Greek', 'f', 1.6, 143),
('AUS', 'Italian', 'f', 2.2, 176),
('AUS', 'Serbo-Croatian', 'f', 0.6, 366),
('AUS', 'Vietnamese', 'f', 0.8, 439),
('AUT', 'Czech', 'f', 0.2, 92),
('AUT', 'German', 't', 92, 135),
('AUT', 'Hungarian', 'f', 0.4, 167),
('AUT', 'Polish', 'f', 0.2, 337),
('AUT', 'Romanian', 'f', 0.2, 348),
('AUT', 'Serbo-Croatian', 'f', 2.2, 366),
('AUT', 'Slovene', 'f', 0.4, 378),
('AUT', 'Turkish', 'f', 1.5, 428),
('AZE', 'Armenian', 'f', 2, 20),
('AZE', 'Azerbaijani', 't', 89, 25),
('AZE', 'Lezgian', 'f', 2.3, 218),
('AZE', 'Russian', 'f', 3, 352),
('BDI', 'French', 't', 0, 119),
('BDI', 'Kirundi', 't', 98.1, 201),
('BDI', 'Swahili', 'f', 0, 395),
('BEL', 'Arabic', 'f', 1.6, 15),
('BEL', 'Dutch', 't', 59.2, 105),
('BEL', 'French', 't', 32.6, 119),
('BEL', 'German', 't', 1, 135),
('BEL', 'Italian', 'f', 2.4, 176),
('BEL', 'Turkish', 'f', 0.9, 428),
('BEN', 'Adja', 'f', 11.1, 3),
('BEN', 'Aizo', 'f', 8.7, 8),
('BEN', 'Bariba', 'f', 8.7, 37),
('BEN', 'Fon', 'f', 39.8, 118),
('BEN', 'Ful', 'f', 5.6, 123),
('BEN', 'Joruba', 'f', 12.2, 179),
('BEN', 'Somba', 'f', 6.7, 381),
('BFA', 'Busansi', 'f', 3.5, 60),
('BFA', 'Dagara', 'f', 3.1, 94),
('BFA', 'Dyula', 'f', 2.6, 106),
('BFA', 'Ful', 'f', 9.7, 123),
('BFA', 'Gurma', 'f', 5.7, 150),
('BFA', 'Mossi', 'f', 50.2, 291),
('BGD', 'Bengali', 't', 97.7, 45),
('BGD', 'Chakma', 'f', 0.4, 69),
('BGD', 'Garo', 'f', 0.1, 132),
('BGD', 'Khasi', 'f', 0.1, 194),
('BGD', 'Marma', 'f', 0.2, 263),
('BGD', 'Santhali', 'f', 0.1, 360),
('BGD', 'Tripuri', 'f', 0.1, 420),
('BGR', 'Bulgariana', 't', 83.2, 55),
('BGR', 'Macedonian', 'f', 2.6, 235),
('BGR', 'Romani', 'f', 3.7, 347),
('BGR', 'Turkish', 'f', 9.4, 428),
('BHR', 'Arabic', 't', 67.7, 15),
('BHR', 'English', 'f', 0, 110),
('BHS', 'Creole English', 'f', 89.7, 88),
('BHS', 'Creole French', 'f', 10.3, 89),
('BIH', 'Serbo-Croatian', 't', 99.2, 366),
('BLR', 'Belorussian', 't', 65.6, 43),
('BLR', 'Polish', 'f', 0.6, 337),
('BLR', 'Russian', 't', 32, 352),
('BLR', 'Ukrainian', 'f', 1.3, 434),
('BLZ', 'English', 't', 50.8, 110),
('BLZ', 'Garifuna', 'f', 6.8, 131),
('BLZ', 'Maya Languages', 'f', 9.6, 267),
('BLZ', 'Spanish', 'f', 31.6, 390),
('BMU', 'English', 't', 100, 110),
('BOL', 'Aimar ', 't', 3.2, 6),
('BOL', 'Guaran ', 'f', 0.1, 145),
('BOL', 'Ket ua', 't', 8.1, 193),
('BOL', 'Spanish', 't', 87.7, 390),
('BRA', 'German', 'f', 0.5, 135),
('BRA', 'Indian Languages', 'f', 0.2, 174),
('BRA', 'Italian', 'f', 0.4, 176),
('BRA', 'Japanese', 'f', 0.4, 177),
('BRA', 'Portuguese', 't', 97.5, 339),
('BRB', 'Bajan', 'f', 95.1, 27),
('BRB', 'English', 't', 0, 110),
('BRN', 'Chinese', 'f', 9.3, 77),
('BRN', 'English', 'f', 3.1, 110),
('BRN', 'Malay', 't', 45.5, 245),
('BRN', 'Malay-English', 'f', 28.8, 246),
('BTN', 'Asami', 'f', 15.2, 21),
('BTN', 'Dzongkha', 't', 50, 107),
('BTN', 'Nepali', 'f', 34.8, 299),
('BWA', 'Khoekhoe', 'f', 2.5, 196),
('BWA', 'Ndebele', 'f', 1.3, 298),
('BWA', 'San', 'f', 3.5, 358),
('BWA', 'Shona', 'f', 12.3, 371),
('BWA', 'Tswana', 'f', 75.5, 424),
('CAF', 'Banda', 'f', 23.5, 34),
('CAF', 'Gbaya', 'f', 23.8, 133),
('CAF', 'Mandjia', 'f', 14.8, 254),
('CAF', 'Mbum', 'f', 6.4, 272),
('CAF', 'Ngbaka', 'f', 7.5, 302),
('CAF', 'Sara', 'f', 6.4, 361),
('CAN', 'Chinese', 'f', 2.5, 77),
('CAN', 'Dutch', 'f', 0.5, 105),
('CAN', 'English', 't', 60.4, 110),
('CAN', 'Eskimo Languages', 'f', 0.1, 111),
('CAN', 'French', 't', 23.4, 119),
('CAN', 'German', 'f', 1.6, 135),
('CAN', 'Italian', 'f', 1.7, 176),
('CAN', 'Polish', 'f', 0.7, 337),
('CAN', 'Portuguese', 'f', 0.7, 339),
('CAN', 'Punjabi', 'f', 0.7, 340),
('CAN', 'Spanish', 'f', 0.7, 390),
('CAN', 'Ukrainian', 'f', 0.6, 434),
('CCK', 'English', 't', 0, 110),
('CCK', 'Malay', 'f', 0, 245),
('CHE', 'French', 't', 19.2, 119),
('CHE', 'German', 't', 63.6, 135),
('CHE', 'Italian', 't', 7.7, 176),
('CHE', 'Romansh', 't', 0.6, 349),
('CHL', 'Aimar ', 'f', 0.5, 6),
('CHL', 'Araucan', 'f', 9.6, 18),
('CHL', 'Rapa nui', 'f', 0.2, 346),
('CHL', 'Spanish', 't', 89.7, 390),
('CHN', 'Chinese', 't', 92, 77),
('CHN', 'Dong', 'f', 0.2, 101),
('CHN', 'Hui', 'f', 0.8, 166),
('CHN', 'Mant u', 'f', 0.9, 257),
('CHN', 'Miao', 'f', 0.7, 276),
('CHN', 'Mongolian', 'f', 0.4, 286),
('CHN', 'Puyi', 'f', 0.2, 343),
('CHN', 'Tibetan', 'f', 0.4, 413),
('CHN', 'Tujia', 'f', 0.5, 425),
('CHN', 'Uighur', 'f', 0.6, 433),
('CHN', 'Yi', 'f', 0.6, 451),
('CHN', 'Zhuang', 'f', 1.4, 456),
('CIV', 'Akan', 'f', 30, 9),
('CIV', 'Gur', 'f', 11.7, 148),
('CIV', 'Kru', 'f', 10.5, 209),
('CIV', 'Malinke', 'f', 11.4, 248),
('CIV', '[South]Mande', 'f', 7.7, 388),
('CMR', 'Bamileke-bamum', 'f', 18.6, 33),
('CMR', 'Duala', 'f', 10.9, 103),
('CMR', 'Fang', 'f', 19.7, 114),
('CMR', 'Ful', 'f', 9.6, 123),
('CMR', 'Maka', 'f', 4.9, 240),
('CMR', 'Mandara', 'f', 5.7, 252),
('CMR', 'Masana', 'f', 3.9, 266),
('CMR', 'Tikar', 'f', 7.4, 416),
('COD', 'Boa', 'f', 2.3, 51),
('COD', 'Chokwe', 'f', 1.8, 79),
('COD', 'Kongo', 'f', 16, 203),
('COD', 'Luba', 'f', 18, 225),
('COD', 'Mongo', 'f', 13.5, 285),
('COD', 'Ngala and Bangi', 'f', 5.8, 301),
('COD', 'Rundi', 'f', 3.8, 351),
('COD', 'Rwanda', 'f', 10.3, 353),
('COD', 'Teke', 'f', 2.7, 406),
('COD', 'Zande', 'f', 6.1, 453),
('COG', 'Kongo', 'f', 51.5, 203),
('COG', 'Mbete', 'f', 4.8, 270),
('COG', 'Mboshi', 'f', 11.4, 271),
('COG', 'Punu', 'f', 2.9, 341),
('COG', 'Sango', 'f', 2.6, 359),
('COG', 'Teke', 'f', 17.3, 406),
('COK', 'English', 'f', 0, 110),
('COK', 'Maori', 't', 0, 258),
('COL', 'Arawakan', 'f', 0.1, 19),
('COL', 'Caribbean', 'f', 0.1, 64),
('COL', 'Chibcha', 'f', 0.4, 73),
('COL', 'Creole English', 'f', 0.1, 88),
('COL', 'Spanish', 't', 99, 390),
('COM', 'Comorian', 't', 75, 83),
('COM', 'Comorian-Arabic', 'f', 1.6, 84),
('COM', 'Comorian-French', 'f', 12.9, 85),
('COM', 'Comorian-madagassi', 'f', 5.5, 86),
('COM', 'Comorian-Swahili', 'f', 0.5, 87),
('CPV', 'Crioulo', 'f', 100, 90),
('CPV', 'Portuguese', 't', 0, 339),
('CRI', 'Chibcha', 'f', 0.3, 73),
('CRI', 'Chinese', 'f', 0.2, 77),
('CRI', 'Creole English', 'f', 2, 88),
('CRI', 'Spanish', 't', 97.5, 390),
('CUB', 'Spanish', 't', 100, 390),
('CXR', 'Chinese', 'f', 0, 77),
('CXR', 'English', 't', 0, 110),
('CYM', 'English', 't', 0, 110),
('CYP', 'Greek', 't', 74.1, 143),
('CYP', 'Turkish', 't', 22.4, 428),
('CZE', 'Czech', 't', 81.2, 92),
('CZE', 'German', 'f', 0.5, 135),
('CZE', 'Hungarian', 'f', 0.2, 167),
('CZE', 'Moravian', 'f', 12.9, 288),
('CZE', 'Polish', 'f', 0.6, 337),
('CZE', 'Romani', 'f', 0.3, 347),
('CZE', 'Silesiana', 'f', 0.4, 373),
('CZE', 'Slovak', 'f', 3.1, 377),
('DEU', 'German', 't', 91.3, 135),
('DEU', 'Greek', 'f', 0.4, 143),
('DEU', 'Italian', 'f', 0.7, 176),
('DEU', 'Polish', 'f', 0.3, 337),
('DEU', 'Southern Slavic Languages', 'f', 1.4, 387),
('DEU', 'Turkish', 'f', 2.6, 428),
('DJI', 'Afar', 'f', 34.8, 4),
('DJI', 'Arabic', 't', 10.6, 15),
('DJI', 'Somali', 'f', 43.9, 380),
('DMA', 'Creole English', 'f', 100, 88),
('DMA', 'Creole French', 'f', 0, 89),
('DNK', 'Arabic', 'f', 0.7, 15),
('DNK', 'Danish', 't', 93.5, 95),
('DNK', 'English', 'f', 0.3, 110),
('DNK', 'German', 'f', 0.5, 135),
('DNK', 'Norwegian', 'f', 0.3, 307),
('DNK', 'Swedish', 'f', 0.3, 397),
('DNK', 'Turkish', 'f', 0.8, 428),
('DOM', 'Creole French', 'f', 2, 89),
('DOM', 'Spanish', 't', 98, 390),
('DZA', 'Arabic', 't', 86, 15),
('DZA', 'Berberi', 'f', 14, 46),
('ECU', 'Ket ua', 'f', 7, 193),
('ECU', 'Spanish', 't', 93, 390),
('EGY', 'Arabic', 't', 98.8, 15),
('EGY', 'Sinaberberi', 'f', 0, 374),
('ERI', 'Afar', 'f', 4.3, 4),
('ERI', 'Bilin', 'f', 3, 49),
('ERI', 'Hadareb', 'f', 3.8, 153),
('ERI', 'Saho', 'f', 3, 355),
('ERI', 'Tigre', 'f', 31.7, 414),
('ERI', 'Tigrinja', 't', 49.1, 415),
('ESH', 'Arabic', 't', 100, 15),
('ESP', 'Basque', 'f', 1.6, 39),
('ESP', 'Catalan', 'f', 16.9, 66),
('ESP', 'Galecian', 'f', 6.4, 129),
('ESP', 'Spanish', 't', 74.4, 390),
('EST', 'Belorussian', 'f', 1.4, 43),
('EST', 'Estonian', 't', 65.3, 112),
('EST', 'Finnish', 'f', 0.7, 117),
('EST', 'Russian', 'f', 27.8, 352),
('EST', 'Ukrainian', 'f', 2.8, 434),
('ETH', 'Amhara', 'f', 30, 12),
('ETH', 'Gurage', 'f', 4.7, 149),
('ETH', 'Oromo', 'f', 31, 319),
('ETH', 'Sidamo', 'f', 3.2, 372),
('ETH', 'Somali', 'f', 4.1, 380),
('ETH', 'Tigrinja', 'f', 7.2, 415),
('ETH', 'Walaita', 'f', 2.8, 440),
('FIN', 'Estonian', 'f', 0.2, 112),
('FIN', 'Finnish', 't', 92.7, 117),
('FIN', 'Russian', 'f', 0.4, 352),
('FIN', 'Saame', 'f', 0, 354),
('FIN', 'Swedish', 't', 5.7, 397),
('FJI', 'Fijian', 't', 50.8, 116),
('FJI', 'Hindi', 'f', 43.7, 164),
('FLK', 'English', 't', 0, 110),
('FRA', 'Arabic', 'f', 2.5, 15),
('FRA', 'French', 't', 93.6, 119),
('FRA', 'Italian', 'f', 0.4, 176),
('FRA', 'Portuguese', 'f', 1.2, 339),
('FRA', 'Spanish', 'f', 0.4, 390),
('FRA', 'Turkish', 'f', 0.4, 428),
('FRO', 'Danish', 't', 0, 95),
('FRO', 'Faroese', 't', 100, 115),
('FSM', 'Kosrean', 'f', 7.3, 206),
('FSM', 'Mortlock', 'f', 7.6, 290),
('FSM', 'Pohnpei', 'f', 23.8, 336),
('FSM', 'Trukese', 'f', 41.6, 421),
('FSM', 'Wolea', 'f', 3.7, 445),
('FSM', 'Yap', 'f', 5.8, 450),
('GAB', 'Fang', 'f', 35.8, 114),
('GAB', 'Mbete', 'f', 13.8, 270),
('GAB', 'Mpongwe', 'f', 14.6, 292),
('GAB', 'Punu-sira-nzebi', 'f', 17.1, 342),
('GBR', 'English', 't', 97.3, 110),
('GBR', 'Gaeli', 'f', 0.1, 127),
('GBR', 'Kymri', 'f', 0.9, 213),
('GEO', 'Abhyasi', 'f', 1.7, 1),
('GEO', 'Armenian', 'f', 6.8, 20),
('GEO', 'Azerbaijani', 'f', 5.5, 25),
('GEO', 'Georgiana', 't', 71.7, 134),
('GEO', 'Osseetti', 'f', 2.4, 320),
('GEO', 'Russian', 'f', 8.8, 352),
('GHA', 'Akan', 'f', 52.4, 9),
('GHA', 'Ewe', 'f', 11.9, 113),
('GHA', 'Ga-adangme', 'f', 7.8, 126),
('GHA', 'Gurma', 'f', 3.3, 150),
('GHA', 'Joruba', 'f', 1.3, 179),
('GHA', 'Mossi', 'f', 15.8, 291),
('GIB', 'Arabic', 'f', 7.4, 15),
('GIB', 'English', 't', 88.9, 110),
('GIN', 'Ful', 'f', 38.6, 123),
('GIN', 'Kissi', 'f', 6, 202),
('GIN', 'Kpelle', 'f', 4.6, 208),
('GIN', 'Loma', 'f', 2.3, 221),
('GIN', 'Malinke', 'f', 23.2, 248),
('GIN', 'Susu', 'f', 11, 394),
('GIN', 'Yalunka', 'f', 2.9, 448),
('GLP', 'Creole French', 'f', 95, 89),
('GLP', 'French', 't', 0, 119),
('GMB', 'Diola', 'f', 9.2, 100),
('GMB', 'Ful', 'f', 16.2, 123),
('GMB', 'Malinke', 'f', 34.1, 248),
('GMB', 'Soninke', 'f', 7.6, 384),
('GMB', 'Wolof', 'f', 12.6, 446),
('GNB', 'Balante', 'f', 14.6, 29),
('GNB', 'Crioulo', 'f', 36.4, 90),
('GNB', 'Ful', 'f', 16.6, 123),
('GNB', 'Malinke', 'f', 6.9, 248),
('GNB', 'Mandyako', 'f', 4.9, 255),
('GNB', 'Portuguese', 't', 8.1, 339),
('GNQ', 'Bubi', 'f', 8.7, 53),
('GNQ', 'Fang', 'f', 84.8, 114),
('GRC', 'Greek', 't', 98.5, 143),
('GRC', 'Turkish', 'f', 0.9, 428),
('GRD', 'Creole English', 'f', 100, 88),
('GRL', 'Danish', 't', 12.5, 95),
('GRL', 'Greenlandic', 't', 87.5, 144),
('GTM', 'Cakchiquel', 'f', 8.9, 61),
('GTM', 'Kekch ', 'f', 4.9, 192),
('GTM', 'Mam', 'f', 2.7, 250),
('GTM', 'Quich ', 'f', 10.1, 344),
('GTM', 'Spanish', 't', 64.7, 390),
('GUF', 'Creole French', 'f', 94.3, 89),
('GUF', 'Indian Languages', 'f', 1.9, 174),
('GUM', 'Chamorro', 't', 29.6, 70),
('GUM', 'English', 't', 37.5, 110),
('GUM', 'Japanese', 'f', 2, 177),
('GUM', 'Korean', 'f', 3.3, 205),
('GUM', 'Philippene Languages', 'f', 19.7, 333),
('GUY', 'Arawakan', 'f', 1.4, 19),
('GUY', 'Caribbean', 'f', 2.2, 64),
('GUY', 'Creole English', 'f', 96.4, 88),
('HKG', 'Canton Chinese', 'f', 88.7, 62),
('HKG', 'Chiu chau', 'f', 1.4, 78),
('HKG', 'English', 't', 2.2, 110),
('HKG', 'Fukien', 'f', 1.9, 122),
('HKG', 'Hakka', 'f', 1.6, 156),
('HND', 'Creole English', 'f', 0.2, 88),
('HND', 'Garifuna', 'f', 1.3, 131),
('HND', 'Miskito', 'f', 0.2, 279),
('HND', 'Spanish', 't', 97.2, 390),
('HRV', 'Serbo-Croatian', 't', 95.9, 366),
('HRV', 'Slovene', 'f', 0, 378),
('HTI', 'French', 't', 0, 119),
('HTI', 'Haiti Creole', 'f', 100, 155),
('HUN', 'German', 'f', 0.4, 135),
('HUN', 'Hungarian', 't', 98.5, 167),
('HUN', 'Romani', 'f', 0.5, 347),
('HUN', 'Romanian', 'f', 0.1, 348),
('HUN', 'Serbo-Croatian', 'f', 0.2, 366),
('HUN', 'Slovak', 'f', 0.1, 377),
('IDN', 'Bali', 'f', 1.7, 30),
('IDN', 'Banja', 'f', 1.8, 35),
('IDN', 'Batakki', 'f', 2.2, 41),
('IDN', 'Bugi', 'f', 2.2, 54),
('IDN', 'Javanese', 'f', 39.4, 178),
('IDN', 'Madura', 'f', 4.3, 236),
('IDN', 'Malay', 't', 12.1, 245),
('IDN', 'Minangkabau', 'f', 2.4, 278),
('IDN', 'Sunda', 'f', 15.8, 393),
('IND', 'Asami', 'f', 1.5, 21),
('IND', 'Bengali', 'f', 8.2, 45),
('IND', 'Gujarati', 'f', 4.8, 147),
('IND', 'Hindi', 't', 39.9, 164),
('IND', 'Kannada', 'f', 3.9, 185),
('IND', 'Malajalam', 'f', 3.6, 244),
('IND', 'Marathi', 'f', 7.4, 260),
('IND', 'Orija', 'f', 3.3, 318),
('IND', 'Punjabi', 'f', 2.8, 340),
('IND', 'Tamil', 'f', 6.3, 403),
('IND', 'Telugu', 'f', 7.8, 407),
('IND', 'Urdu', 'f', 5.1, 436),
('IRL', 'English', 't', 98.4, 110),
('IRL', 'Irish', 't', 1.6, 175),
('IRN', 'Arabic', 'f', 2.2, 15),
('IRN', 'Azerbaijani', 'f', 16.8, 25),
('IRN', 'Bakhtyari', 'f', 1.7, 28),
('IRN', 'Balochi', 'f', 2.3, 31),
('IRN', 'Gilaki', 'f', 5.3, 136),
('IRN', 'Kurdish', 'f', 9.1, 211),
('IRN', 'Luri', 'f', 4.3, 232),
('IRN', 'Mazandarani', 'f', 3.6, 269),
('IRN', 'Persian', 't', 45.7, 332),
('IRN', 'Turkmenian', 'f', 1.6, 429),
('IRQ', 'Arabic', 't', 77.2, 15),
('IRQ', 'Assyrian', 'f', 0.8, 22),
('IRQ', 'Azerbaijani', 'f', 1.7, 25),
('IRQ', 'Kurdish', 'f', 19, 211),
('IRQ', 'Persian', 'f', 0.8, 332),
('ISL', 'English', 'f', 0, 110),
('ISL', 'Icelandic', 't', 95.7, 171),
('ISR', 'Arabic', 't', 18, 15),
('ISR', 'Hebrew', 't', 63.1, 160),
('ISR', 'Russian', 'f', 8.9, 352),
('ITA', 'Albaniana', 'f', 0.2, 10),
('ITA', 'French', 'f', 0.5, 119),
('ITA', 'Friuli', 'f', 1.2, 121),
('ITA', 'German', 'f', 0.5, 135),
('ITA', 'Italian', 't', 94.1, 176),
('ITA', 'Romani', 'f', 0.2, 347),
('ITA', 'Sardinian', 'f', 2.7, 363),
('ITA', 'Slovene', 'f', 0.2, 378),
('JAM', 'Creole English', 'f', 94.2, 88),
('JAM', 'Hindi', 'f', 1.9, 164),
('JOR', 'Arabic', 't', 97.9, 15),
('JOR', 'Armenian', 'f', 1, 20),
('JOR', 'Circassian', 'f', 1, 82),
('JPN', 'Ainu', 'f', 0, 7),
('JPN', 'Chinese', 'f', 0.2, 77),
('JPN', 'English', 'f', 0.1, 110),
('JPN', 'Japanese', 't', 99.1, 177),
('JPN', 'Korean', 'f', 0.5, 205),
('JPN', 'Philippene Languages', 'f', 0.1, 333),
('KAZ', 'German', 'f', 3.1, 135),
('KAZ', 'Kazakh', 't', 46, 191),
('KAZ', 'Russian', 'f', 34.7, 352),
('KAZ', 'Tatar', 'f', 2, 405),
('KAZ', 'Ukrainian', 'f', 5, 434),
('KAZ', 'Uzbek', 'f', 2.3, 437),
('KEN', 'Gusii', 'f', 6.1, 151),
('KEN', 'Kalenjin', 'f', 10.8, 182),
('KEN', 'Kamba', 'f', 11.2, 183),
('KEN', 'Kikuyu', 'f', 20.9, 198),
('KEN', 'Luhya', 'f', 13.8, 229),
('KEN', 'Luo', 'f', 12.8, 231),
('KEN', 'Masai', 'f', 1.6, 265),
('KEN', 'Meru', 'f', 5.5, 275),
('KEN', 'Nyika', 'f', 4.8, 316),
('KEN', 'Turkana', 'f', 1.4, 427),
('KGZ', 'Kazakh', 'f', 0.8, 191),
('KGZ', 'Kirgiz', 't', 59.7, 199),
('KGZ', 'Russian', 't', 16.2, 352),
('KGZ', 'Tadzhik', 'f', 0.8, 398),
('KGZ', 'Tatar', 'f', 1.3, 405),
('KGZ', 'Ukrainian', 'f', 1.7, 434),
('KGZ', 'Uzbek', 'f', 14.1, 437),
('KHM', 'Chinese', 'f', 3.1, 77),
('KHM', 'Khmer', 't', 88.6, 195),
('KHM', 'T am', 'f', 2.4, 431),
('KHM', 'Vietnamese', 'f', 5.5, 439),
('KIR', 'Kiribati', 't', 98.9, 200),
('KIR', 'Tuvalu', 'f', 0.5, 430),
('KNA', 'Creole English', 'f', 100, 88),
('KNA', 'English', 't', 0, 110),
('KOR', 'Chinese', 'f', 0.1, 77),
('KOR', 'Korean', 't', 99.9, 205),
('KWT', 'Arabic', 't', 78.1, 15),
('KWT', 'English', 'f', 0, 110),
('LAO', 'Lao', 't', 67.2, 215),
('LAO', 'Lao-Soung', 'f', 5.2, 216),
('LAO', 'Mon-khmer', 'f', 16.5, 287),
('LAO', 'Thai', 'f', 7.8, 410),
('LBN', 'Arabic', 't', 93, 15),
('LBN', 'Armenian', 'f', 5.9, 20),
('LBN', 'French', 'f', 0, 119),
('LBR', 'Bassa', 'f', 13.7, 40),
('LBR', 'Gio', 'f', 7.9, 137),
('LBR', 'Grebo', 'f', 8.9, 142),
('LBR', 'Kpelle', 'f', 19.5, 208),
('LBR', 'Kru', 'f', 7.2, 209),
('LBR', 'Loma', 'f', 5.8, 221),
('LBR', 'Malinke', 'f', 5.1, 248),
('LBR', 'Mano', 'f', 7.2, 256),
('LBY', 'Arabic', 't', 96, 15),
('LBY', 'Berberi', 'f', 1, 46),
('LCA', 'Creole French', 'f', 80, 89),
('LCA', 'English', 't', 20, 110);

INSERT INTO "public"."countrylanguage" ("countrycode", "language", "isofficial", "percentage", "languagecode") VALUES
('LIE', 'German', 't', 89, 135),
('LIE', 'Italian', 'f', 2.5, 176),
('LIE', 'Turkish', 'f', 2.5, 428),
('LKA', 'Mixed Languages', 'f', 19.6, 280),
('LKA', 'Singali', 't', 60.3, 376),
('LKA', 'Tamil', 't', 19.6, 403),
('LSO', 'English', 't', 0, 110),
('LSO', 'Sotho', 't', 85, 386),
('LSO', 'Zulu', 'f', 15, 457),
('LTU', 'Belorussian', 'f', 1.4, 43),
('LTU', 'Lithuanian', 't', 81.6, 220),
('LTU', 'Polish', 'f', 7, 337),
('LTU', 'Russian', 'f', 8.1, 352),
('LTU', 'Ukrainian', 'f', 1.1, 434),
('LUX', 'French', 't', 4.2, 119),
('LUX', 'German', 't', 2.3, 135),
('LUX', 'Italian', 'f', 4.6, 176),
('LUX', 'Luxembourgish', 't', 64.4, 234),
('LUX', 'Portuguese', 'f', 13, 339),
('LVA', 'Belorussian', 'f', 4.1, 43),
('LVA', 'Latvian', 't', 55.1, 217),
('LVA', 'Lithuanian', 'f', 1.2, 220),
('LVA', 'Polish', 'f', 2.1, 337),
('LVA', 'Russian', 'f', 32.5, 352),
('LVA', 'Ukrainian', 'f', 2.9, 434),
('MAC', 'Canton Chinese', 'f', 85.6, 62),
('MAC', 'English', 'f', 0.5, 110),
('MAC', 'Mandarin Chinese', 'f', 1.2, 253),
('MAC', 'Portuguese', 't', 2.3, 339),
('MAR', 'Arabic', 't', 65, 15),
('MAR', 'Berberi', 'f', 33, 46),
('MCO', 'English', 'f', 6.5, 110),
('MCO', 'French', 't', 41.9, 119),
('MCO', 'Italian', 'f', 16.1, 176),
('MCO', 'Monegasque', 'f', 16.1, 284),
('MDA', 'Bulgariana', 'f', 1.6, 55),
('MDA', 'Gagauzi', 'f', 3.2, 128),
('MDA', 'Romanian', 't', 61.9, 348),
('MDA', 'Russian', 'f', 23.2, 352),
('MDA', 'Ukrainian', 'f', 8.6, 434),
('MDG', 'French', 't', 0, 119),
('MDG', 'Malagasy', 't', 98.9, 243),
('MDV', 'Dhivehi', 't', 100, 98),
('MDV', 'English', 'f', 0, 110),
('MEX', 'Mixtec', 'f', 0.6, 281),
('MEX', 'N huatl', 'f', 1.8, 317),
('MEX', 'Otom ', 'f', 0.4, 321),
('MEX', 'Spanish', 't', 92.1, 390),
('MEX', 'Yucatec', 'f', 1.1, 452),
('MEX', 'Zapotec', 'f', 0.6, 454),
('MHL', 'English', 't', 0, 110),
('MHL', 'Marshallese', 't', 96.8, 264),
('MKD', 'Albaniana', 'f', 22.9, 10),
('MKD', 'Macedonian', 't', 66.5, 235),
('MKD', 'Romani', 'f', 2.3, 347),
('MKD', 'Serbo-Croatian', 'f', 2, 366),
('MKD', 'Turkish', 'f', 4, 428),
('MLI', 'Bambara', 'f', 31.8, 32),
('MLI', 'Ful', 'f', 13.9, 123),
('MLI', 'Senufo and Minianka', 'f', 12, 365),
('MLI', 'Songhai', 'f', 6.9, 382),
('MLI', 'Soninke', 'f', 8.7, 384),
('MLI', 'Tamashek', 'f', 7.3, 402),
('MLT', 'English', 't', 2.1, 110),
('MLT', 'Maltese', 't', 95.8, 249),
('MMR', 'Burmese', 't', 69, 58),
('MMR', 'Chin', 'f', 2.2, 76),
('MMR', 'Kachin', 'f', 1.4, 181),
('MMR', 'Karen', 'f', 6.2, 188),
('MMR', 'Kayah', 'f', 0.4, 190),
('MMR', 'Mon', 'f', 2.4, 283),
('MMR', 'Rakhine', 'f', 4.5, 345),
('MMR', 'Shan', 'f', 8.5, 370),
('MNG', 'Bajad', 'f', 1.9, 26),
('MNG', 'Buryat', 'f', 1.7, 59),
('MNG', 'Dariganga', 'f', 1.4, 97),
('MNG', 'Dorbet', 'f', 2.7, 102),
('MNG', 'Kazakh', 'f', 5.9, 191),
('MNG', 'Mongolian', 't', 78.8, 286),
('MNP', 'Carolinian', 'f', 4.8, 65),
('MNP', 'Chamorro', 'f', 30, 70),
('MNP', 'Chinese', 'f', 7.1, 77),
('MNP', 'English', 't', 4.8, 110),
('MNP', 'Korean', 'f', 6.5, 205),
('MNP', 'Philippene Languages', 'f', 34.1, 333),
('MOZ', 'Chuabo', 'f', 5.7, 80),
('MOZ', 'Lomwe', 'f', 7.8, 222),
('MOZ', 'Makua', 'f', 27.8, 242),
('MOZ', 'Marendje', 'f', 3.5, 261),
('MOZ', 'Nyanja', 'f', 3.3, 315),
('MOZ', 'Ronga', 'f', 3.7, 350),
('MOZ', 'Sena', 'f', 9.4, 364),
('MOZ', 'Shona', 'f', 6.5, 371),
('MOZ', 'Tsonga', 'f', 12.4, 422),
('MOZ', 'Tswa', 'f', 6, 423),
('MRT', 'Ful', 'f', 1.2, 123),
('MRT', 'Hassaniya', 'f', 81.7, 157),
('MRT', 'Soninke', 'f', 2.7, 384),
('MRT', 'Tukulor', 'f', 5.4, 426),
('MRT', 'Wolof', 'f', 6.6, 446),
('MRT', 'Zenaga', 'f', 1.2, 455),
('MSR', 'English', 't', 0, 110),
('MTQ', 'Creole French', 'f', 96.6, 89),
('MTQ', 'French', 't', 0, 119),
('MUS', 'Bhojpuri', 'f', 21.1, 47),
('MUS', 'Creole French', 'f', 70.6, 89),
('MUS', 'French', 'f', 3.4, 119),
('MUS', 'Hindi', 'f', 1.2, 164),
('MUS', 'Marathi', 'f', 0.7, 260),
('MUS', 'Tamil', 'f', 0.8, 403),
('MWI', 'Chichewa', 't', 58.3, 74),
('MWI', 'Lomwe', 'f', 18.4, 222),
('MWI', 'Ngoni', 'f', 6.7, 303),
('MWI', 'Yao', 'f', 13.2, 449),
('MYS', 'Chinese', 'f', 9, 77),
('MYS', 'Dusun', 'f', 1.1, 104),
('MYS', 'English', 'f', 1.6, 110),
('MYS', 'Iban', 'f', 2.8, 168),
('MYS', 'Malay', 't', 58.4, 245),
('MYS', 'Tamil', 'f', 3.9, 403),
('MYT', 'French', 't', 20.3, 119),
('MYT', 'Mahor ', 'f', 41.9, 238),
('MYT', 'Malagasy', 'f', 16.1, 243),
('NAM', 'Afrikaans', 'f', 9.5, 5),
('NAM', 'Caprivi', 'f', 4.7, 63),
('NAM', 'German', 'f', 0.9, 135),
('NAM', 'Herero', 'f', 8, 162),
('NAM', 'Kavango', 'f', 9.7, 189),
('NAM', 'Nama', 'f', 12.4, 295),
('NAM', 'Ovambo', 'f', 50.7, 323),
('NAM', 'San', 'f', 1.9, 358),
('NCL', 'French', 't', 34.3, 119),
('NCL', 'Malenasian Languages', 'f', 45.4, 247),
('NCL', 'Polynesian Languages', 'f', 11.6, 338),
('NER', 'Ful', 'f', 9.7, 123),
('NER', 'Hausa', 'f', 53.1, 158),
('NER', 'Kanuri', 'f', 4.4, 186),
('NER', 'Songhai-zerma', 'f', 21.2, 383),
('NER', 'Tamashek', 'f', 10.4, 402),
('NFK', 'English', 't', 0, 110),
('NGA', 'Bura', 'f', 1.6, 57),
('NGA', 'Edo', 'f', 3.3, 108),
('NGA', 'Ful', 'f', 11.3, 123),
('NGA', 'Hausa', 'f', 21.1, 158),
('NGA', 'Ibibio', 'f', 5.6, 169),
('NGA', 'Ibo', 'f', 18.1, 170),
('NGA', 'Ijo', 'f', 1.8, 172),
('NGA', 'Joruba', 'f', 21.4, 179),
('NGA', 'Kanuri', 'f', 4.1, 186),
('NGA', 'Tiv', 'f', 2.3, 417),
('NIC', 'Creole English', 'f', 0.5, 88),
('NIC', 'Miskito', 'f', 1.6, 279),
('NIC', 'Spanish', 't', 97.6, 390),
('NIC', 'Sumo', 'f', 0.2, 392),
('NIU', 'English', 't', 0, 110),
('NIU', 'Niue', 'f', 0, 304),
('NLD', 'Arabic', 'f', 0.9, 15),
('NLD', 'Dutch', 't', 95.6, 105),
('NLD', 'Fries', 'f', 3.7, 120),
('NLD', 'Turkish', 'f', 0.8, 428),
('NOR', 'Danish', 'f', 0.4, 95),
('NOR', 'English', 'f', 0.5, 110),
('NOR', 'Norwegian', 't', 96.6, 307),
('NOR', 'Saame', 'f', 0, 354),
('NOR', 'Swedish', 'f', 0.3, 397),
('NPL', 'Bhojpuri', 'f', 7.5, 47),
('NPL', 'Hindi', 'f', 3, 164),
('NPL', 'Maithili', 'f', 11.9, 239),
('NPL', 'Nepali', 't', 50.4, 299),
('NPL', 'Newari', 'f', 3.7, 300),
('NPL', 'Tamang', 'f', 4.9, 401),
('NPL', 'Tharu', 'f', 5.4, 411),
('NRU', 'Chinese', 'f', 8.5, 77),
('NRU', 'English', 't', 7.5, 110),
('NRU', 'Kiribati', 'f', 17.9, 200),
('NRU', 'Nauru', 't', 57.5, 297),
('NRU', 'Tuvalu', 'f', 8.5, 430),
('NZL', 'English', 't', 87, 110),
('NZL', 'Maori', 'f', 4.3, 258),
('OMN', 'Arabic', 't', 76.7, 15),
('OMN', 'Balochi', 'f', 0, 31),
('PAK', 'Balochi', 'f', 3, 31),
('PAK', 'Brahui', 'f', 1.2, 52),
('PAK', 'Hindko', 'f', 2.4, 165),
('PAK', 'Pashto', 'f', 13.1, 331),
('PAK', 'Punjabi', 'f', 48.2, 340),
('PAK', 'Saraiki', 'f', 9.8, 362),
('PAK', 'Sindhi', 'f', 11.8, 375),
('PAK', 'Urdu', 't', 7.6, 436),
('PAN', 'Arabic', 'f', 0.6, 15),
('PAN', 'Creole English', 'f', 14, 88),
('PAN', 'Cuna', 'f', 2, 91),
('PAN', 'Embera', 'f', 0.6, 109),
('PAN', 'Guaym ', 'f', 5.3, 146),
('PAN', 'Spanish', 't', 76.8, 390),
('PCN', 'Pitcairnese', 'f', 0, 335),
('PER', 'Aimar ', 't', 2.3, 6),
('PER', 'Ket ua', 't', 16.4, 193),
('PER', 'Spanish', 't', 79.8, 390),
('PHL', 'Bicol', 'f', 5.7, 48),
('PHL', 'Cebuano', 'f', 23.3, 67),
('PHL', 'Hiligaynon', 'f', 9.1, 163),
('PHL', 'Ilocano', 'f', 9.3, 173),
('PHL', 'Maguindanao', 'f', 1.4, 237),
('PHL', 'Maranao', 'f', 1.3, 259),
('PHL', 'Pampango', 'f', 3, 327),
('PHL', 'Pangasinan', 'f', 1.8, 328),
('PHL', 'Pilipino', 't', 29.3, 334),
('PHL', 'Waray-waray', 'f', 3.8, 442),
('PLW', 'Chinese', 'f', 1.6, 77),
('PLW', 'English', 't', 3.2, 110),
('PLW', 'Palau', 't', 82.2, 326),
('PLW', 'Philippene Languages', 'f', 9.2, 333),
('PNG', 'Malenasian Languages', 'f', 20, 247),
('PNG', 'Papuan Languages', 'f', 78.1, 330),
('POL', 'Belorussian', 'f', 0.5, 43),
('POL', 'German', 'f', 1.3, 135),
('POL', 'Polish', 't', 97.6, 337),
('POL', 'Ukrainian', 'f', 0.6, 434),
('PRI', 'English', 'f', 47.4, 110),
('PRI', 'Spanish', 't', 51.3, 390),
('PRK', 'Chinese', 'f', 0.1, 77),
('PRK', 'Korean', 't', 99.9, 205),
('PRT', 'Portuguese', 't', 99, 339),
('PRY', 'German', 'f', 0.9, 135),
('PRY', 'Guaran ', 't', 40.1, 145),
('PRY', 'Portuguese', 'f', 3.2, 339),
('PRY', 'Spanish', 't', 55.1, 390),
('PSE', 'Arabic', 'f', 95.9, 15),
('PSE', 'Hebrew', 'f', 4.1, 160),
('PYF', 'Chinese', 'f', 2.9, 77),
('PYF', 'French', 't', 40.8, 119),
('PYF', 'Tahitian', 'f', 46.4, 400),
('QAT', 'Arabic', 't', 40.7, 15),
('QAT', 'Urdu', 'f', 0, 436),
('REU', 'Chinese', 'f', 2.8, 77),
('REU', 'Comorian', 'f', 2.8, 83),
('REU', 'Creole French', 'f', 91.5, 89),
('REU', 'Malagasy', 'f', 1.4, 243),
('REU', 'Tamil', 'f', 0, 403),
('ROM', 'German', 'f', 0.4, 135),
('ROM', 'Hungarian', 'f', 7.2, 167),
('ROM', 'Romani', 't', 0.7, 347),
('ROM', 'Romanian', 't', 90.7, 348),
('ROM', 'Serbo-Croatian', 'f', 0.1, 366),
('ROM', 'Ukrainian', 'f', 0.3, 434),
('RUS', 'Avarian', 'f', 0.4, 24),
('RUS', 'Bashkir', 'f', 0.7, 38),
('RUS', 'Belorussian', 'f', 0.3, 43),
('RUS', 'Chechen', 'f', 0.6, 71),
('RUS', 'Chuvash', 'f', 0.9, 81),
('RUS', 'Kazakh', 'f', 0.4, 191),
('RUS', 'Mari', 'f', 0.4, 262),
('RUS', 'Mordva', 'f', 0.5, 289),
('RUS', 'Russian', 't', 86.6, 352),
('RUS', 'Tatar', 'f', 3.2, 405),
('RUS', 'Udmur', 'f', 0.3, 432),
('RUS', 'Ukrainian', 'f', 1.3, 434),
('RWA', 'French', 't', 0, 119),
('RWA', 'Rwanda', 't', 100, 353),
('SAU', 'Arabic', 't', 95, 15),
('SDN', 'Arabic', 't', 49.4, 15),
('SDN', 'Bari', 'f', 2.5, 36),
('SDN', 'Beja', 'f', 6.4, 42),
('SDN', 'Chilluk', 'f', 1.7, 75),
('SDN', 'Dinka', 'f', 11.5, 99),
('SDN', 'Fur', 'f', 2.1, 124),
('SDN', 'Lotuko', 'f', 1.5, 223),
('SDN', 'Nubian Languages', 'f', 8.1, 309),
('SDN', 'Nuer', 'f', 4.9, 310),
('SDN', 'Zande', 'f', 2.7, 453),
('SEN', 'Diola', 'f', 5, 100),
('SEN', 'Ful', 'f', 21.7, 123),
('SEN', 'Malinke', 'f', 3.8, 248),
('SEN', 'Serer', 'f', 12.5, 367),
('SEN', 'Soninke', 'f', 1.3, 384),
('SEN', 'Wolof', 't', 48.1, 446),
('SGP', 'Chinese', 't', 77.1, 77),
('SGP', 'Malay', 't', 14.1, 245),
('SGP', 'Tamil', 't', 7.4, 403),
('SHN', 'English', 't', 0, 110),
('SJM', 'Norwegian', 't', 0, 307),
('SJM', 'Russian', 'f', 0, 352),
('SLB', 'Malenasian Languages', 'f', 85.6, 247),
('SLB', 'Papuan Languages', 'f', 8.6, 330),
('SLB', 'Polynesian Languages', 'f', 3.8, 338),
('SLE', 'Bullom-sherbro', 'f', 3.8, 56),
('SLE', 'Ful', 'f', 3.8, 123),
('SLE', 'Kono-vai', 'f', 5.1, 204),
('SLE', 'Kuranko', 'f', 3.4, 210),
('SLE', 'Limba', 'f', 8.3, 219),
('SLE', 'Mende', 'f', 34.8, 274),
('SLE', 'Temne', 'f', 31.8, 408),
('SLE', 'Yalunka', 'f', 3.4, 448),
('SLV', 'Nahua', 'f', 0, 294),
('SLV', 'Spanish', 't', 100, 390),
('SMR', 'Italian', 't', 100, 176),
('SOM', 'Arabic', 't', 0, 15),
('SOM', 'Somali', 't', 98.3, 380),
('SPM', 'French', 't', 0, 119),
('STP', 'Crioulo', 'f', 86.3, 90),
('STP', 'French', 'f', 0.7, 119),
('SUR', 'Hindi', 'f', 0, 164),
('SUR', 'Sranantonga', 'f', 81, 391),
('SVK', 'Czech and Moravian', 'f', 1.1, 93),
('SVK', 'Hungarian', 'f', 10.5, 167),
('SVK', 'Romani', 'f', 1.7, 347),
('SVK', 'Slovak', 't', 85.6, 377),
('SVK', 'Ukrainian and Russian', 'f', 0.6, 435),
('SVN', 'Hungarian', 'f', 0.5, 167),
('SVN', 'Serbo-Croatian', 'f', 7.9, 366),
('SVN', 'Slovene', 't', 87.9, 378),
('SWE', 'Arabic', 'f', 0.8, 15),
('SWE', 'Finnish', 'f', 2.4, 117),
('SWE', 'Norwegian', 'f', 0.5, 307),
('SWE', 'Southern Slavic Languages', 'f', 1.3, 387),
('SWE', 'Spanish', 'f', 0.6, 390),
('SWE', 'Swedish', 't', 89.5, 397),
('SWZ', 'Swazi', 't', 89.9, 396),
('SWZ', 'Zulu', 'f', 2, 457),
('SYC', 'English', 't', 3.8, 110),
('SYC', 'French', 't', 1.3, 119),
('SYC', 'Seselwa', 'f', 91.3, 368),
('SYR', 'Arabic', 't', 90, 15),
('SYR', 'Kurdish', 'f', 9, 211),
('TCA', 'English', 't', 0, 110),
('TCD', 'Arabic', 't', 12.3, 15),
('TCD', 'Gorane', 'f', 6.2, 141),
('TCD', 'Hadjarai', 'f', 6.7, 154),
('TCD', 'Kanem-bornu', 'f', 9, 184),
('TCD', 'Mayo-kebbi', 'f', 11.5, 268),
('TCD', 'Ouaddai', 'f', 8.7, 322),
('TCD', 'Sara', 'f', 27.7, 361),
('TCD', 'Tandjile', 'f', 6.5, 404),
('TGO', 'Ane', 'f', 5.7, 14),
('TGO', 'Ewe', 't', 23.2, 113),
('TGO', 'Gurma', 'f', 3.4, 150),
('TGO', 'Kaby ', 't', 13.8, 180),
('TGO', 'Kotokoli', 'f', 5.7, 207),
('TGO', 'Moba', 'f', 5.4, 282),
('TGO', 'Naudemba', 'f', 4.1, 296),
('TGO', 'Watyi', 'f', 10.3, 444),
('THA', 'Chinese', 'f', 12.1, 77),
('THA', 'Khmer', 'f', 1.3, 195),
('THA', 'Kuy', 'f', 1.1, 212),
('THA', 'Lao', 'f', 26.9, 215),
('THA', 'Malay', 'f', 3.6, 245),
('THA', 'Thai', 't', 52.6, 410),
('TJK', 'Russian', 'f', 9.7, 352),
('TJK', 'Tadzhik', 't', 62.2, 398),
('TJK', 'Uzbek', 'f', 23.2, 437),
('TKL', 'English', 't', 0, 110),
('TKL', 'Tokelau', 'f', 0, 418),
('TKM', 'Kazakh', 'f', 2, 191),
('TKM', 'Russian', 'f', 6.7, 352),
('TKM', 'Turkmenian', 't', 76.7, 429),
('TKM', 'Uzbek', 'f', 9.2, 437),
('TMP', 'Portuguese', 't', 0, 339),
('TMP', 'Sunda', 'f', 0, 393),
('TON', 'English', 't', 0, 110),
('TON', 'Tongan', 't', 98.3, 419),
('TTO', 'Creole English', 'f', 2.9, 88),
('TTO', 'English', 'f', 93.5, 110),
('TTO', 'Hindi', 'f', 3.4, 164),
('TUN', 'Arabic', 't', 69.9, 15),
('TUN', 'Arabic-French', 'f', 26.3, 16),
('TUN', 'Arabic-French-English', 'f', 3.2, 17),
('TUR', 'Arabic', 'f', 1.4, 15),
('TUR', 'Kurdish', 'f', 10.6, 211),
('TUR', 'Turkish', 't', 87.6, 428),
('TUV', 'English', 't', 0, 110),
('TUV', 'Kiribati', 'f', 7.5, 200),
('TUV', 'Tuvalu', 't', 92.5, 430),
('TWN', 'Ami', 'f', 0.6, 13),
('TWN', 'Atayal', 'f', 0.4, 23),
('TWN', 'Hakka', 'f', 11, 156),
('TWN', 'Mandarin Chinese', 't', 20.1, 253),
('TWN', 'Min', 'f', 66.7, 277),
('TWN', 'Paiwan', 'f', 0.3, 325),
('TZA', 'Chaga and Pare', 'f', 4.9, 68),
('TZA', 'Gogo', 'f', 3.9, 140),
('TZA', 'Ha', 'f', 3.5, 152),
('TZA', 'Haya', 'f', 5.9, 159),
('TZA', 'Hehet', 'f', 6.9, 161),
('TZA', 'Luguru', 'f', 4.9, 228),
('TZA', 'Makonde', 'f', 5.9, 241),
('TZA', 'Nyakusa', 'f', 5.4, 312),
('TZA', 'Nyamwesi', 'f', 21.1, 313),
('TZA', 'Shambala', 'f', 4.3, 369),
('TZA', 'Swahili', 't', 8.8, 395),
('UGA', 'Acholi', 'f', 4.4, 2),
('UGA', 'Ganda', 'f', 18.1, 130),
('UGA', 'Gisu', 'f', 4.5, 138),
('UGA', 'Kiga', 'f', 8.3, 197),
('UGA', 'Lango', 'f', 5.9, 214),
('UGA', 'Lugbara', 'f', 4.7, 227),
('UGA', 'Nkole', 'f', 10.7, 305),
('UGA', 'Rwanda', 'f', 3.2, 353),
('UGA', 'Soga', 'f', 8.2, 379),
('UGA', 'Teso', 'f', 6, 409),
('UKR', 'Belorussian', 'f', 0.3, 43),
('UKR', 'Bulgariana', 'f', 0.3, 55),
('UKR', 'Hungarian', 'f', 0.3, 167),
('UKR', 'Polish', 'f', 0.1, 337),
('UKR', 'Romanian', 'f', 0.7, 348),
('UKR', 'Russian', 'f', 32.9, 352),
('UKR', 'Ukrainian', 't', 64.7, 434),
('UMI', 'English', 't', 0, 110),
('URY', 'Spanish', 't', 95.7, 390),
('USA', 'Chinese', 'f', 0.6, 77),
('USA', 'English', 't', 86.2, 110),
('USA', 'French', 'f', 0.7, 119),
('USA', 'German', 'f', 0.7, 135),
('USA', 'Italian', 'f', 0.6, 176),
('USA', 'Japanese', 'f', 0.2, 177),
('USA', 'Korean', 'f', 0.3, 205),
('USA', 'Polish', 'f', 0.3, 337),
('USA', 'Portuguese', 'f', 0.2, 339),
('USA', 'Spanish', 'f', 7.5, 390),
('USA', 'Tagalog', 'f', 0.4, 399),
('USA', 'Vietnamese', 'f', 0.2, 439),
('UZB', 'Karakalpak', 'f', 2, 187),
('UZB', 'Kazakh', 'f', 3.8, 191),
('UZB', 'Russian', 'f', 10.9, 352),
('UZB', 'Tadzhik', 'f', 4.4, 398),
('UZB', 'Tatar', 'f', 1.8, 405),
('UZB', 'Uzbek', 't', 72.6, 437),
('VAT', 'Italian', 't', 0, 176),
('VCT', 'Creole English', 'f', 99.1, 88),
('VCT', 'English', 't', 0, 110),
('VEN', 'Goajiro', 'f', 0.4, 139),
('VEN', 'Spanish', 't', 96.9, 390),
('VEN', 'Warrau', 'f', 0.1, 443),
('VGB', 'English', 't', 0, 110),
('VIR', 'English', 't', 81.7, 110),
('VIR', 'French', 'f', 2.5, 119),
('VIR', 'Spanish', 'f', 13.3, 390),
('VNM', 'Chinese', 'f', 1.4, 77),
('VNM', 'Khmer', 'f', 1.4, 195),
('VNM', 'Man', 'f', 0.7, 251),
('VNM', 'Miao', 'f', 0.9, 276),
('VNM', 'Muong', 'f', 1.5, 293),
...
('VNM', 'Thai', 'f', 1.6, 410),
('VNM', 'Tho', 'f', 1.8, 412),
('VNM', 'Vietnamese', 't', 86.8, 439),
('VUT', 'Bislama', 't', 56.6, 50),
('VUT', 'English', 't', 28.3, 110),
('VUT', 'French', 't', 14.2, 119),
('WLF', 'Futuna', 'f', 0, 125),
('WLF', 'Wallis', 'f', 0, 441),
('WSM', 'English', 't', 0.6, 110),
('WSM', 'Samoan', 't', 47.5, 356),
('WSM', 'Samoan-English', 'f', 52, 357),
('YEM', 'Arabic', 't', 99.6, 15),
('YEM', 'Soqutri', 'f', 0, 385),
('YUG', 'Albaniana', 'f', 16.5, 10),
('YUG', 'Hungarian', 'f', 3.4, 167),
('YUG', 'Macedonian', 'f', 0.5, 235),
('YUG', 'Romani', 'f', 1.4, 347),
('YUG', 'Serbo-Croatian', 't', 75.2, 366),
('YUG', 'Slovak', 'f', 0.7, 377),
('ZAF', 'Afrikaans', 't', 14.3, 5),
('ZAF', 'English', 't', 8.5, 110),
('ZAF', 'Ndebele', 'f', 1.5, 298),
('ZAF', 'Northsotho', 'f', 9.1, 306),
('ZAF', 'Southsotho', 'f', 7.6, 389),
('ZAF', 'Swazi', 'f', 2.5, 396),
('ZAF', 'Tsonga', 'f', 4.3, 422),
('ZAF', 'Tswana', 'f', 8.1, 424),
('ZAF', 'Venda', 'f', 2.2, 438),
('ZAF', 'Xhosa', 't', 17.7, 447),
('ZAF', 'Zulu', 't', 22.7, 457),
('ZMB', 'Bemba', 'f', 29.7, 44),
('ZMB', 'Chewa', 'f', 5.7, 72),
('ZMB', 'Lozi', 'f', 6.4, 224),
('ZMB', 'Nsenga', 'f', 4.3, 308),
('ZMB', 'Nyanja', 'f', 7.8, 315),
('ZMB', 'Tongan', 'f', 11, 419),
('ZWE', 'English', 't', 2.2, 110),
('ZWE', 'Ndebele', 'f', 16.2, 298),
('ZWE', 'Nyanja', 'f', 2.2, 315),
('ZWE', 'Shona', 'f', 72.1, 371);
