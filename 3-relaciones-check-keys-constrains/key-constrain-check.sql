...
-- 1. RELATIONS, CHECKS, KEYS AND CONSTRAINTS
-- 1.1 TYPE RELATIONSHIPS
-- 1.2 ONE TO ONE
-- 1.3 ONE TO MANY
-- 1.4 SELF JOINING RELATIONSHIPS
-- 1.5 MANY TO MANY 
...
-- 2.4 FOREIGN KEY
-- 2.5 COMPOSITE KEY
-- 3. DELETION AND CASCADE UPDATES
-- 4. AUTOMATIC ACTIONS
...
-- INSERT DATA IN COUNTRY-LANGUAGE
...
--ALTERATE TABLE FOR ADD PRIMARY KEY
ALTER TABLE country ADD PRIMARY KEY (code);

--ADD CONSTRAIN CHECKS AS VALIDATIONS
ALTER TABLE country ADD CHECK(surfacearea >= 0);
SELECT DISTINCT continent FROM country;

ALTER TABLE country ADD CHECK( continent IN ( 'Asia', 'South America', 'North America', 'Oceania', 'Antarctica', 'Africa', 'Europe' ) );

ALTER TABLE country DROP CONSTRAINT "country_continent_check";

ALTER TABLE country ADD CHECK( continent IN ( 'Asia', 'South America', 'North America', 'Oceania', 'Antarctica', 'Africa', 'Europe', 'Central America' ) );


-- TABLE DESCRIPTION WITH CHECK CONSTRAINS
CREATE TABLE "public"."country" (
    "code" bpchar(3) NOT NULL,
    "name" text NOT NULL,
    "continent" text NOT NULL CHECK( continent IN ( 'Asia', 'South America', 'North America', 'Oceania', 'Antarctica', 'Africa', 'Europe', 'Central America' ) ),
    "region" text NOT NULL,
    "surfacearea" float4 NOT NULL,
    "indepyear" int2,
    "population" int4 NOT NULL,
...
-- CREATE INDEX - FOR TO MAKE QUERIES FASTER
...
-- 1. CREATE A PRIMARY KEY IN CITY (ID)
ALTER TABLE city ADD PRIMARY KEY (id);

-- 2. CREATE A CHECK IN POPULATION, SO THAT IT DOES NOT SUPPORT NEGATIVES 
ALTER TABLE city ADD CHECK(population >= 0);
SELECT * FROM city;

-- 3. CREATE A COMPOSITE PRIMARY KEY IN "COUNTRYLANGUAGE"
-- THE FIELDS TO USE AS A COMPOSITE KEY ARE COUNTRYCODE AND LANGUAGE
ALTER TABLE countrylanguage ADD PRIMARY KEY (countrycode, language);

-- 4. CREATE CHECK IN PERCENTAGE
-- SO THAT IT DOES NOT ALLOW NEGATIVES OR NUMBERS GREATER THAN 100
...
CREATE INDEX "index_disctrict" ON city (district);
